<div>
    <form wire:submit.prevent="submit" id="StudentCreateForm">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <x-input-text name="code" type="number" placeholder="Student Code" wireModel="code">
                                    </x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8" id="datepicker2">
                                    <x-input-text name="dob" type="date" placeholder="mm/dd/yyyy" wireModel="dob">
                                    </x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8 d-flex align-items-center">
                                    <input name="approved_for_observation" type="checkbox" id="switch1" switch="none"
                                           wire:model="approved_for_observation" checked/>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_name" placeholder="Father Name" wireModel="father_name"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_number" placeholder="Father's Number" wireModel="father_number"></x-input-text>
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_profession" placeholder="Father's profession" wireModel="father_profession">
                                    </x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_email" placeholder="Father's Email" wireModel="father_email"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_doc" placeholder="Father's Document" wireModel="father_doc"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="father_fb_link" placeholder="Father's FB link" wireModel="father_fb_link">
                                    </x-input-text>
                                </div>
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_name" placeholder="Mother Name" wireModel="mother_name"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_number" placeholder="Mother Number" wireModel="mother_number"></x-input-text>
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_profession" placeholder="Mother's profession" wireModel="mother_profession">
                                    </x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_email" placeholder="Mother's Email" wireModel="mother_email"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_doc" placeholder="Mother's Document" wireModel="mother_doc"></x-input-text>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-12">
                                    <x-input-text name="mother_fb_link" placeholder="Mother's FB link" wireModel="mother_fb_link">
                                    </x-input-text>
                                </div>
                            </div>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary waves-effect waves-light" wire:click="store()">Save changes</button>
        </div>
    </form>
</div>
