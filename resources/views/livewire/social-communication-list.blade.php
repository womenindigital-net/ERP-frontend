        ...
        <table class="table table-bordered w-100">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <a href="{{ route('social-communication.show','1') }}" target="_blank" rel="noopener noreferrer"  class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1">
