        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <x-input-select wireModel="warehouse_id" :records="$warehouses"
                    ...
                    <div class="card-body">
                        ...
                        <div class="repeater">
                                    ...
                                    <div data-repeater-item class="row removeRow">
                                        ...
                                        <div class=" col-lg-2 p-0 pe-1 pb-1">
                                            <x-input-text type="text"
                                                          wireModel="available_qty.{{$key}}"></x-input-text>
                                        </div>

                                        <div class=" col-lg-2 p-0 pe-1 pb-1">
                                            <x-input-text type="text"
                                                          wireModel="qty.{{$key}}"></x-input-text>
                                        </div>

                                        <div class=" col-lg-1 p-0 pe-1 pb-1">
                                            <x-input-text type="text"
                                                          wireModel="sub_total.{{$key}}"></x-input-text>
                                        </div>
                                        <div class=" col-lg-1 p-0 pe-1 pb-1">
                                            <x-input-text type="text"
                                                          wireModel="price.{{$key}}"></x-input-text>
                                        </div>
                                        <div class=" col-lg-2 p-0 pe-1 pb-1 d-flex">
                                            <x-input-text type="text"
                                                          wireModel="discount.{{$key}}"></x-input-text>
                                            <div>
                            ...
                            <input data-repeater-create type="button"
                                   class="btn btn-success mt-3 mt-lg-0" value="Add" wire:click="addMore()"/>
                        </div>
                        <!-- 7th row start  -->
