        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <x-input-select wireModel="project_id" :records="$projects"
                                    targetColumn="title"/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <x-input-select wireModel="customer_id" :records="$customers"
                                    additional="mobile"/>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <x-input-text wireModel="ship_to_address"
