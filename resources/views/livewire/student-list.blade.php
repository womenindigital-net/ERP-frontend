            ...
            <table class="table table-bordered w-100">
                ...
                <tbody>
                    @foreach ($records as $record)
                        <tr>
                            <td><a href="student.student_profile.profile">{{ $record->name }}</a></td>
                            ...
                            <td>
                                <a href="{{ route('student.show', $record->id) }}" target="_blank"
                                ...
                                <a href="{{ route('student.edit', $record->id) }}" target="_blank"
                                    rel="noopener noreferrer"
