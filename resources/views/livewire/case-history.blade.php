<div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-end">
                            <button type="button" class="btn btn-outline-info waves-effect waves-light"
                                    ...
                                    data-bs-target=".bs-example-modal-lg" wire:click="show()" wire:key>ADD
                            </button>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="modal fade bs-example-modal-lg @if($mode === 'view') apply-view-only @endif" tabindex="-1" role="dialog"
         aria-labelledby="myLargeModalLabel" wire:ignore
         aria-hidden="true">
                ...
                <div class="modal-body">
                    <div id="vertical-example" class="vertical-wizard">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <x-input-text wireModel="phone"></x-input-text>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="verticalnav-email-input">Email</label>
                                            <x-input-text wireModel="email"></x-input-text>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <x-input-textarea wireModel="address"></x-input-textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <section>
                            <form>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3>Instruction:</h3>
                                        <p>আপনার জানা তথ্য ও জ্ঞান অনুযায়ী নিচের তথ্যাবলী প্রেরণ করুন। সঠিক উত্তর না
                                            জানা থাকলে ‘জানি না’
                                            লিখুন। উত্তরের জন্য প্রয়োজনীয় জায়গা না থাকলে আলাদা কাগজ ব্যবহার করে উত্তর
                      ...
                      দেয়া)" :records="$constants::$yesNo"
                                                        wireModel="has_adjustment_capability"></x-input-radio-or-check>
                                <!-- end row -->
                                <x-input-radio-or-check label="চলাফেরার ক্ষেত্রে ভারসাম্য আছে কি? <br>(যেমন-হাটার সময় পড়ে যাওয়া, হাটার সময় শরীর দোলানো, থপ থপ জোরে হাটা, বেখাপ্পা ভাবে
                ...
                অনুযায়ী খেলা / সঠিক ভাবে খেলা / খেলার প্রতি আগ্রহ / খেলার উপকরন চাওয়া)" :records="$constants::$yesNo">
                            ...
                            <!-- end row -->
                                <x-input-radio-or-check wireModel="has_speaking_problem"
                                                        ...
                                                        secondaryInputWire="has_speaking_problem_additional"></x-input-radio-or-check>
                                <!-- end row -->
                            ...
                            <div>
                                ...
                                <!-- end row -->
                                    <x-input-radio-or-check name="child_description"
                                                            ...
                                                            type="checkbox"
                                                            secondaryInputWire="child_description_additional"
                                                            secondaryInputLabel="স্পেশালিষ্ট এর পদবি ও বিস্তারিত লিখুন।">
                                    </x-input-radio-or-check>
                        ...
                        <section>
                            <div>
                                ...
                                {{--todo--}}
                                <!-- end row -->
                                    <x-input-radio-or-check wireModel="first_voice_lang"
                                ...
                                <form>
                                    ...
                                    <div class="row border-top py-2">
                                        <div class="col-xl-12 col-sm-12">
                                            <div class="mb-2">
                                                <h5 class="">স্কুলের কাজের ক্ষেত্রে আপনার সন্তানের প্রধান উদ্বেগের
                                                    কারন/বিষয় গুলি কি কি ? উল্লেখ
                                                    করুন-</h5>
                                                <div class="input-group" id="datepicker2">
                            ...
                            <div>
                                ...
                                <form>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if($mode === 'create')
                                            <button type="button" class="btn btn-primary waves-effect waves-light" wire:click="save()">
                                                Save changes
                                            </button>
                                        @elseif ($mode === 'edit')
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                    wire:click="save({{$recordId}})">
                                                Update changes
                                            </button>
                                        @endif
                                    </div>
    ...
    <!-- form wizard init -->
        ...
        <script>
            window.addEventListener ( 'inject', event => {
                let {record, mode, recordId} = event.detail;
                console.log ( record, mode, recordId );
                let key = "wire:click";
                let val = `save(${record}, ${mode}, ${recordId})`;

                let actions = document.querySelector ( ".actions" );
                console.log ( `actions: ${actions}` )
                let ul = actions.getElementsByTagName ( 'ul' )[0];
                if (ul) {
                    console.log ( `ul: ${ul}` )
                    let lis = ul.getElementsByTagName ( 'li' );
                    console.log ( `li: ${lis}` )
                    if (lis) {
                        for (let eachLi of lis) {
                            if ( eachLi.textContent === 'Finish' ) {
                                // eachLi.setAttribute ( key, val )
                            }
                        }
                    }
                }
            ...
            /*$ ( function () {
                window.addEventListener ( 'inject', event => {
                    ...
                    for (let eachLi of lis) {
                        if ( eachLi.textContent === 'Finish' ) {
                            eachLi.setAttribute ( "wire:click", "show()" )
                        }
                    }
                } );
