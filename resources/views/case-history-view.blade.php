                ...
                <div class="col-sm-3 col-md-3">
                  <div id="wizard-navigation">
                    <ul class="wizard-navigation">
                      <li class="w-100"><a href="#caseHistoryInit" data-toggle="tab">Case History Init</a></li>
                      <li class="w-100"><a href="#referralInformation" data-toggle="tab">রেফারাল তথ্য</a></li>
                      <li class="w-100"><a href="#TheTrendOfEvolution" data-toggle="tab">ক্রমউন্নয়নের ধারা</a></li>
                      <li class="w-100"><a href="#HistoryOfDevelopment" data-toggle="tab">উন্নয়নের ইতিহাস</a></li>
                      <li class="w-100"><a href="#LanguageSkills" data-toggle="tab">ভাষার দক্ষতা</a></li>
                      <li class="w-100"><a href="#WorkingSkills" data-toggle="tab">কাজ করার দক্ষতা</a></li>
                      <li class="w-100"><a href="#SocialSkills" data-toggle="tab">সামাজিক দক্ষতা</a></li>
                      <li class="w-100"><a href="#LearningSkills" data-toggle="tab">শেখার দক্ষতা</a></li>
                      <li class="w-100"><a href="#Self-reliance" data-toggle="tab">স্বনির্ভরতা</a></li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="referralInformation">
                        <section>
                          ...
                          <!-- end row -->
                          <x-input-radio-or-check name="has_past_assessment_by_specialist"
                          ...
                          <!-- end row -->
                          <x-input-radio-or-check name="has_family_learning_disability"
                            label="লার্নিং ডিজাবিলিটি বা কোন কিছু শিখতে পারাতে কোন সমস্যা পরিবারে কারো ছিল কিনা?"
                            :records="$constants::$yesNo">
                          </x-input-radio-or-check>
                          <!-- end row -->
                          <x-input-radio-or-check name="has_instability" label="সন্তানের মধ্যে অস্থিরতা আছে কিনা"
                            :records="$constants::$yesNo">
                          </x-input-radio-or-check>
                        </section>
                      </div>
                      <div class="tab-pane" id="TheTrendOfEvolution">
                        <section>
                          ...
                          <x-input-radio-or-check name="child_description"
                            ...
                            secondaryInputLabel="স্পেশালিষ্ট এর পদবি ও বিস্তারিত লিখুন।" :multiple="true">
                          </x-input-radio-or-check>
                      ...
                      <div class="tab-pane" id="HistoryOfDevelopment">
                        <section>
                          <div>
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_to_lick' label="চুষে খেতে পারে কিনা ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_to_eat_hard_thing' label="শক্ত খাবার খেতে পারে কিনা?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_to_control_breathing'
                              label="শ্বাস-প্রশ্বাস নিয়ন্ত্রন করতে পারে কিনা?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_take_longer_time_while_eating'
                              label="খাবার খেতে লম্বা সময় নেয় কিনা?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='is_any_problem_in_chewing_food'
                              label="চিবিয়ে খাবার খেতে কোন সমস্যা ছিল কিনা" :records="$constants::$yesNo"
                              secondaryInputLabel="স্পেশালিষ্ট এর পদবি ও বিস্তারিত লিখুন।">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='sat_alone_in' label="কোন বয়সে একা একা বসতে শিখেছে?"
                              :records="$caseConstants::$inWhichAgeLearnedToSitAlone" :isVertical="false">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='learned_to_chewing_in' label="কোন বয়সে চাবানো শিখেছে ?"
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_to_swimming' label="শিশু কি সাঁতার জানে ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='dose_have_balancing_problem' label="ভারসাম্য হীনতা আছে কিনা?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='dose_have_muscle_pain' label="পেশী ব্যথা সব সময় থাকে কিনা?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                          </div>
                        </section>
                      ...
                      <div class="tab-pane" id="LanguageSkills">
                        <section>
                          <div>
                            <!-- end row -->
                            <x-input-radio-or-check name='first_voice_lang' label="শিশুর কথা বলার প্রথম ভাষা কোনটি?"
                              :records="$caseConstants::$firstVoiceLang" secondaryInputLabel="অন্য ভাষা হলে তা লিখুন">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='in_which_age_spoke_the_first_word'
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_spake_simple_sentence' label="সহজ বাক্য বলতে পারে কি?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='how_many_word_use_in_a_sentence_max'
                            ...
                            <x-input-radio-or-check name='dose_spake_in_other_lang'
                              label="অন্য কোন ভাষায় কথা বলতে পারে কি?" :records="$constants::$yesNo">
                            </x-input-radio-or-check> --}}
                            <!-- end row -->
                            <x-input-radio-or-check name='dose_spake_in_other_lang' label="অন্য কোন ভাষা বলতে পারে?"
                              :records="$caseConstants::$doseSpakeInOtherLang"
                              secondaryInputLabel="অন্য ভাষা হলে তা লিখুন">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='from_which_year_learning_other_lang'
                              label="কোন বয়স থেকে শিখেছে ?" :records="$caseConstants::$fromWhichYearLearnigOtherLang"
                              :isVertical="false">
                            </x-input-radio-or-check>

                            <!-- end row -->
                            <x-input-radio-or-check name='from_where_learn_other_lang'
                              label="কোথা থেকে সেই ভাষা শিখেছে ?" :records="$caseConstants::$fromWhereLearnOtherLang"
                              :isVertical="false">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_he_response_if_call_by_his_name'
                              label="নাম ধরে ডাকলে শিশু সারা দেয় কি?"
                              :records="$caseConstants::$doesHeResponseIfCallByHisName">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_give_simple_instruction_and_follow_direction'
                              label="প্রাথমিক ও সহজ ভাষায় নির্দেশ ও দিক নির্দেশনা অনুসরণ করতে পারে ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='dose_use_wrong_word_while_speaking'
                              label="শিশু কোন কোন শব্দ ভুল উচ্চারণ করে কিনা" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='is_able_to_use_right_word_for_right_sentence'
                      ...
                      <div class="tab-pane" id="WorkingSkills">
                        <section>
                          <div>
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='can_wear_cloth_alone' label="নিজে একা একা কাপড় পরতে পারে ?"
                              :records="$caseConstants::$canWearClothAlone" secondaryInputLabel="বিস্তারিত লিখুন"
                              :isVertical="false">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_arrange_own_things' label="শিশু নিজের জিনিষ গুছিয়ে রাখে ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='in_which_age_got_toilet_training'
                            ...
                            <x-input-radio-or-check name='does_go_to_toilet_himself'
                              label="বাড়িতে কি নিজে নিজে টয়লেটে যায়?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_go_to_toilet_in_unknown_place'
                              label="অপরিচত জায়গায় টয়লেটে যায়?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_like_drawing_and_writing_in_home'
                              label="বাড়িতে কি ছবি আঁকতে, কাটাকাঁটি করতে পছন্দ করে?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_like_play' label="খেলাধুলা করতে পছন্দ করে ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_play_independently' label="সে কি স্বাধীনভাবে খেলতে পারে ?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='favorite_games' label="কি খেলা পছন্দ করে?"
                            ...
                            <x-input-radio-or-check name='can_obey_elder_commends'
                              label="বড়দের নির্দেশ মেনে বা মানিয়ে চলতে পারে" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='do_you_things_obey_elder_elder_is_heard'
                              label="আপনি কি মনে করেন এটা একটি খুবই কঠিন কাজ" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_clean_himself_after_properly'
                              label="টয়লেট থেকে কি একা একা পরিস্কার হয়ে বের হয়ে আসতে পারে?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_wear_cloth_himself_after_properly'
                        ...
                        <section>
                          <div>
                            ...
                            <x-input-radio-or-check name='does_play_with_siblings'
                              label="বাসায় ভাইবোনদের সাথে খেলাধুলা করে কি?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_friend_come_to_play_in_home'
                              label="সন্তানের বন্ধুরা কি বাসায় খেলতে আসে ?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='are_you_tense_for_specific_behaviour'
                          ...
                          <div>
                            ...
                            <div class="row border-top py-2">
                              <div class="col-xl-12 col-sm-12">
                                <div class="mb-2">
                                  <h5 class="">স্কুলের কাজের ক্ষেত্রে আপনার সন্তানের প্রধান উদ্বেগের কারন/বিষয়
                                    গুলি কি কি ? উল্লেখ
                                    করুন-</h5>
                                  <div class="input-group" id="datepicker2">
                                    <x-input-text type="text" name='concerning_points_of_child_school_work'>
                                    </x-input-text>
                                  </div>
                                  <!-- input-->
                                </div>
                              ...
                              <!-- end row -->
                              <x-input-radio-or-check name='is_curious_to_learn_new_things'
                                label="নতুন নতুন বিষয় শেখার আগ্রহ আছে কিনা?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='can_understand_simple_things_right_way'
                                label="যেকোনো সাধারণ বিষয় সঠিকভাবে বুঝতে পারে কিনা?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='can_learn_word_spelling'
                                label="শব্দের বানান শিখতে পারে কিনা?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='can_write_himself' label="নিজে নিজে লিখতে পারে?"
                                :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='working_speed' label="কাজ করার গতি কেমন ?"
                                :records="$caseConstants::$workingSpeed">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='how_long_child_can_remember_after_teaching'
                              ...
                              <!-- end row -->
                              <x-input-radio-or-check name='is_home_work_a_simple_things'
                                label="হোমওয়ার্ক কি তার কাছে সাধারণ কাজ?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='does_change_behaviour_during_homework'
                                label="স্কুলের কাজ করার সময় কি তার ব্যবহার/আচরণ অন্যরকম হয়ে যায়?"
                                :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='is_he_angry' label="তাকে কি উত্তেজিত মনে হয়?"
                                :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='does_feel_messy_about_paper_and_books'
                                label="কাগজপত্র বা বই খাতায় অগোছালো মনে হয়?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                              <x-input-radio-or-check name='does_lose_different_things_from_bags_regularly'
                      ...
                      <div class="tab-pane" id="Self-reliance">
                        <section>
                          <div>
                            <p>আপনার সন্তানের মাঝে নিচের বিষয়গুলির নিয়ে কোন অসুবিধা পরিলক্ষন করেছেন কি? করে থাকলে,
                              কমেন্টে বিস্তারিত
                              লিখুন। এই বিষয়গুলি মুলত স্কুলে যাওয়ার বয়সের জন্য প্রযোজ্যঃ</p>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_irrelevant_work_during_meal'
                              label="খাওয়াদাওয়ার সময় বিশ্রী/বেমানান কাজ করে কিনা যেটা পিতামাতার জন্য বিরক্তি সৃষ্টি করে"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_scream_during_wearing_cloth'
                              label="কাপড় পরিধানঃ বেশি কান্নাকাটি/ চিৎকার করে" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_accept_routing_change'
                              label="রুটিনে কোন পরিবর্তন মেনে নেয় কি?রুটিন পছন্দ করে" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_like_new_situation' label="নতুন পরিস্থিতি পছন্দ করে?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_not_obey_regularity'
                              label="ধারাবাহিক নির্দেশ ঠিক মত পালন করতে পারে না" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_get_angry_quickly'
                              label="মেজাজ খুব তাড়াতাড়ি পরিবর্তিত হয়" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_get_disappointed_quickly' label="সহজে হতাশাগ্রস্থ হয়"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_stop_working' label="কাজ করা বন্ধ করে দেয়"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='can_stay_longer_if_needed' label="অস্থিরতা আছে কি?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_have_tremendous_behaviors_at_home'
                              label="বাসায় ধ্বংসাত্মক বা আক্রমণাত্মক ব্যাবহার আছে কি?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='seems_like_not_interested_in_playing'
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='doest_have_knowledge_problem_about_day_monty_and_time'
                              label="দিন, মাস ও সময় জ্ঞান অর্জনে সমস্যা আছে কি?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='response' label="সারা প্রদান"
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_move_in_one_place' label="এক জায়গায় ঘোরে"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_move' label="ঘোরাঘুরি করে" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_like_to_sit_straight' label="সোজা হয়ে বসতে পছন্দ করে কি?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='is_expert_play_with_ball'
                              label="বল নিয়ে খেলার ক্ষেত্রে পারদর্শী" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_ignore_playing_with_ball'
                              label="বল নিয়ে যে কোন ধরনের খেলা এড়িয়ে চলে" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name='does_run_in_wrong_way' label="বেমানান ভঙ্গিতে দৌঁড়ায়"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='does_height_movement_be_careful_when_going_down_stairs'
                              label="উচ্চতা, নড়াচড়া, সিঁড়ি দিয়ে নামার ক্ষেত্রে সাবধান থাকে"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='try_to_ignore_task' label="কাজ এড়িয়ে চলতে চায়"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='which_kind_of_task_he_try_to_skip'
                              label="কোন ধরনের কাজ এড়িয়ে চলে?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name='lost_again_and_again' label="বার বার হারিয়ে যায়?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                          </div>
