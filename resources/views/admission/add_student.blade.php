                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1">
                                        ...
                                        <button type="button" class="btn btn-sm btn-success btn-rounded waves-effect waves-light mb-2 me-1" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl"prescription>
                                            <i class="fas fa-arrow-circle-right"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger btn-rounded waves-effect waves-light mb-2">
                                        <i class="fas fa-trash-alt"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="number" placeholder="Input your ID" id="example-text-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-search-input" class="col-md-4 col-form-label">Name:</label>
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" placeholder="Your Name" id="example-search-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="" class="col-md-4 col-form-label">Date of Birth:</label>
                                    <div class="col-md-8" id="datepicker2">
                                        <input readonly class="form-control" placeholder="dd/mm/yy"  data-date-format="dd M, yyyy" data-date-container="#datepicker2" data-provide="datepicker" data-date-autoclose="true">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8" id="datepicker2">
                                        <input readonly class="form-control" placeholder="dd/m/yy" data-date-format="dd M, yyyy" data-date-container="#datepicker2" data-provide="datepicker" data-date-autoclose="true">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="number" placeholder="Enter National ID" id="example-tel-input">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" placeholder="Enter your address" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-password-input" class="col-md-4 col-form-label">Parmanent Address:</label>
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" placeholder="Enter your parmanent address" id="example-password-input">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" value="male" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-md-4 col-form-label">Blood Group:</label>
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" value="B+" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-email-input" class="col-md-4 col-form-label">Suborno Card No:</label>
                                    <div class="col-md-8">
                                        <input readonly class="form-control" type="text" placeholder="Enter Card No" id="example-email-input">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's name" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's number" id="example-password-input">
                                    </div>
                                </div>
                                
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's profession" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's Email" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's Document" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Father's FB link" id="example-password-input">
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's name" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's number" id="example-password-input">
                                    </div>
                                </div>
                                
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's profession" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's Email" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's Document" id="example-password-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        <input readonly class="form-control" type="text" placeholder="Enter your Mother's FB link" id="example-password-input">
                                    </div>
                                </div>
