                                            ...
                                            <div class="tab-content apply-view-only">
                                                ...
                                                <div class="tab-pane" id="Muscle_Tone">
                                                    <section>
                                                        ...
                                                        <x-input-radio-or-check label="Lower Limbs" name="lower_limbs_two"
                                                            :checked="$muscle_tone->lower_limbs_two ?? ''" :records="$therapyConstants::$lowerLimbsTone">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->
                                                ...
                                                <div class="tab-pane" id="Range_of_movement">
                                                    <section>
                                                        <x-input-radio-or-check label="Upper limbs"
                                                            name="range_upper_limbs" :checked="$range_of_movement->range_upper_limbs ?? ''" :records="$therapyConstants::$upperLimbs">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->
                                                        <div class="row border-top py-2">
                                                            <div class="col-xl-12 col-sm-12">
                                                        ...
                                                        <x-input-radio-or-check name="range_lower_limbs_two"
                                                            label="Lower limbs" :checked="$range_of_movement->range_lower_limbs_two ?? ''" :records="$therapyConstants::$upperLimbs">
                                                        </x-input-radio-or-check>
                                                    </section>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="Automatic_reaction">
                                                    <section>
                                                        <x-input-radio-or-check label="Protective reactions"
                                                            :checked="$automatic_reaction->protective_reactions ?? ''" :records="$constants::$yesNoEn">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->


                                                        <x-input-radio-or-check label="Equilibrium reaction"
                                                            :checked="$automatic_reaction->equilibrium_reaction ?? ''" :records="$constants::$yesNoEn">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->
                                                    </section>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="Visual_Perception">
                                                    <section>
                                                        ...
                                                        <x-input-radio-or-check :checked="$visual_perception->visual_memory ?? ''" label="Visual Memory"
                                                            :records="$constants::$yesNoEn">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->
                                                ...
                                                <div class="tab-pane" id="Strength">
                                                    <section>
                                                        ...
                                                        <x-input-radio-or-check label="Emotional" :checked="$strength->emotional ?? ''"
                                                            :records="$constants::$yesNoEn">
                                                        </x-input-radio-or-check>
                                                        <!-- row end -->
                                                    </section>
