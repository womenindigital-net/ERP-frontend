                                ...
                                <div class="tab-content">
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-lg-4 pull-left pb-2">
                                                    ...
                                                    <x-input-text value="{{$date}}" name="date" type="date"
                                    ...
                                    <div class="tab-pane" id="Activities_of_Daily_living">
                                        <section>
                                            ...
                                            <x-input-radio-or-check label="Does the child attend school?" :checked="$activities_of_daily_living->any_more_information ??
                                                                        ''" :records="$constants::$yesNoEn">
                                            </x-input-radio-or-check>
                                            <!-- row end -->
                                                            ...
                                                            <div class="form-check">
                                                                <div class="me-5 ">
                                                                    ...
                                                                    <x-input-text type="file"
                                                                        ...
                                                                        name="therapist_signature" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-check">
                                                                <div class="me-5 ">
                                                                    ...
                                                                    <x-input-text
                                                                        ...
                                                                        name="designation_organization" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                            </div>
                                                        </div>
