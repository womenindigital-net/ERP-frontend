                                                ...
                                                <div class="tab-content">
                                                        ...
                                                        <section>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 pull-left pb-2">
                                                                    ...
                                                                    <x-input-select name="candidate_id" :checked="$occupational_therapy->candidate_id ??
                                                                                ''" :records="$students" />
                                                                </div>
                                                    ...
                                                    <div class="tab-pane" id="Fine_motor_skil">
                                                        <section>
                                                            ...
                                                            <x-input-radio-or-check
                                                                :checked="$fine_motor_skill->reach ?? ''" label="Reach"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                    ...
                                                    <div class="tab-pane" id="Sensory_Skill">
                                                        <section>
                                                            <x-input-radio-or-check
                                                                :checked="$sensory_skill->tactile ?? ''" label="Tactile"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                            ...
                                                            <x-input-radio-or-check
                                                                :checked="$sensory_skill->visual ?? ''" label="Visual"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                    ...
                                                    <div class="tab-pane" id="Activities_of_Daily_living">
                                                        <section>
                                                            ...
                                                            <x-input-radio-or-check
                                                                label="Does the child attend school?" :checked="$activities_of_daily_living->any_more_information ??
                                                                        ''" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
