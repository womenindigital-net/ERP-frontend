                ...
                <div class="wizard-container">
                  <div class="card_stap wizard-card row" data-color="red" id="wizard">
                    ...
                    <div class="col-sm-9 col-md-9">
                      <form method="post" action="{{route('functional-movement-skill.store')}}">
                        @csrf
                              ...
                              <div class="row mb-3 mt-3">
                                ...
                                <div class="col-lg-4">
                                  <div class="mb-3">
                                    ...
                                    <x-input-select name="candidate_id" :records="['1'=>'one']" />
                                  </div>
                                </div>
                              </div>
                              <div class="row ">
                                ...
                                <div class="row border-top py-2">
                                  <div class="col-xl-12 col-sm-12">
                                    <div class="m-0">
                                      <div class="form-check d-flex">
                                        <div class="me-5">
                                          <x-input-radio-or-check name="functional_movement_shoulder_1"
                                            :records="$movementSkillsConstants::$accidentOrIncidentThree" />
                                        </div>
                                      </div>
                                    </div>
