                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="Social_Communication">
                                                            ...
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check name="functional_movement_general_1"
                                                                    :records="$movementSkillsConstants::$generalSkills" />
                                                                <!-- end row -->
                                                                <div class="row border-top py-2">
                                                                    ...
                                                                    <x-input-radio-or-check
                                                                        name="functional_movement_general_2"
                                                                    ...
                                                                    <x-input-radio-or-check
                                                                        ...
                                                                        :records="$movementSkillsConstants::$accidentOrIncidentOne" />
                                                            </section>
                                                        </div>
                                                                    ...
                                                                    <div id="" class="">
                                                                        <div class="row mb-3 mt-3">
                                                                            ...
                                                                            <div class="col-md-8"> The single-leg squat
                                                                                with medial rotation. This exercise
                                                                                challenges hip and knee stability. Do not
                                                                                let the knee of the stance leg drift
                                                                                inward.
                                                                                Start with short, slow movements and
                                                                                gradually add range of motion and speed as
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="row mb-3 mt-3">
                                                                        <div class="col-md-4"><img
                                                                                src="{{ asset('images/avatar-19.jpg') }}"
                                                                                alt="image" class="w-100"></div>
                                                                        <div class="col-md-8"> The single-leg squat with
                                                                            medial rotation. This exercise
                                                                            challenges hip and knee stability. Do not let
                                                                            the knee of the stance leg drift
                                                                            inward.
                                                                            Start with short, slow movements and gradually
                                                                            add range of motion and speed as
                                                                            proficiency improves.</div>
                                                                    </div>
                                                                    <x-input-radio-or-check
                                                                ...
                                                                <div>
                                                                    <div class="row mb-3 mt-3">
                                                                        <div class="col-md-4"><img
                                                                                src="{{ asset('images/avatar-19.jpg') }}"
                                                                                alt="image" class="w-100"></div>
                                                                        <div class="col-md-8">Low Back: Walking lunges with
                                                                ...
                                                                <div class="row mb-3 mt-3">
                                                                    <div class="row mb-3 mt-3">
                                                                        <div class="col-md-4"><img
                                                                                src="{{ asset('images/avatar-19.jpg') }}"
                                                                                alt="image" class="w-100"></div>
                                                                        <div class="col-md-8">Tight muscles around the
                                                                            shoulder blades can limit overhead
                                                                            motion. Here the foam roll is used to increase
                                                                            the extensibility of the teres major.
                                                                        </div>
                                                                    </div>
                                                                    <!-- end row -->
                                                                    <div class="row border-top py-2">
