                                                        ...
                                                        <section>
                                                            <form>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <x-input-text
                                                                        :checked="$general->home_equipment ?? ''"
                                                        ...
                                                        <section>
                                                            <form>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <x-input-text
                                                                        :checked="$treatment->problam_list ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="Be">
                                                        <section>
                                                            <form>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$behavior->interpersonal ?? ''"
                                                                    label="Interpersonal"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                        ...
                                                        <section>
                                                            <form>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <x-input-text
                                                                        :checked="$domain_area->behavioral ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$domain_area->communication ?? ''"
                                                                    label="Communication"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$domain_area->social ?? ''" label="Social"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$domain_area->emotional ?? ''"
                ...
                <div id="vertical-example" class="vertical-wizard">
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Visual Memory"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                <!-- end row -->
                                ...
                                <!-- end row -->
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Visual Spatial"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                <!-- end row -->
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Brushing teeth"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                    ...
                    <section>
                        <div>
                            <form>
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Prone to Supine"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Lying to Sit"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Symmetrical use"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Bilateral use"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                ...
                                <!-- end row -->
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Writing skill"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                            </form>
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Proprioceptive"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Problem Solving"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                <!-- end row -->
                                ...
                                <!-- end row -->
                                <!-- end row -->
                                <x-input-radio-or-check name="name" label="Body Awareness"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
                                <!-- end row -->
                    ...
                    <section>
                        <form>
                            ...
                            <!-- end row -->
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Social interaction"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <!-- end row -->
