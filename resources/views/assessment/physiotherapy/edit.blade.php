            ...
            <div class="modal-body">
                <div id="vertical-example" class="vertical-wizard">
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="name" label="Medication Treatment"
                            :records="$constants::$yesNoEn">
                        </x-input-radio-or-check>
                        <!-- row end -->
                        <x-input-radio-or-check name="name" label="Any present medicines"
                            :records="$constants::$yesNoEn">
                        </x-input-radio-or-check>
                        <!-- row end -->
                        <div class="mb-3">
                    ...
                    <section>
                        <div>
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Continuous Rolling"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Box sit to stand"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Jumping" :records="$constants::$yesNoEn">
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Cross sit to stand"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Kneeling to stand:"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                    ...
                    <section>
                        <div>
                            ...
                            <!-- end row -->
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Perceptual Motor"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <!-- end row -->
                            <x-input-radio-or-check name="name" label="Body Co-ordination"
                                :records="$constants::$yesNoEn">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            <!-- end row -->
                    ...
                    <section>
                        ...
                        <!-- end row -->
                        <!-- end row -->
                        <x-input-radio-or-check name="name" label="Social Communication"
                            :records="$constants::$yesNoEn">
                        </x-input-radio-or-check>
                        <!-- end row -->
                        <!-- end row -->
