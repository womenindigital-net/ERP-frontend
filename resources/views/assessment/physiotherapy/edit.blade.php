                                                            ...
                                                            <section>
                                                                <form>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->before_birth ?? ''" name="before_birth"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->pregnancy ?? ''" name="pregnancy"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->during_birth ?? ''" name="during_birth"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->delivery ?? ''" name="delivery"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->after_birth ?? ''" name="after_birth"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->history ?? ''" name="history"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$general->home_equipment ?? ''"
                                                                ...
                                                                <div>
                                                                    <form>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <x-input-text :checked="$fine_motor_skill->left ?? ''" name="left"
                                                                                placeholder="">
                                                                            </x-input-text>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <x-input-text :checked="$fine_motor_skill->right ?? ''" name="right"
                                                                                placeholder="">
                                                                            </x-input-text>
                                                                        </div>
                                                                        <!-- end row -->
                                                            ...
                                                            <section>
                                                                <form>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$treatment->progress ?? ''" name="progress"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                ...
                                                                <form>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="formrow-firstname-input"
                                                                            ...
                                                                            below</label>
                                                                        <x-input-text :checked="$domain_area->if_yes ?? ''" name="if_yes"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text :checked="$domain_area->behavioral ?? ''" name="behavioral"
                                                                            placeholder="">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <!-- row end -->
                                                ...
                                                <div class="tab-content">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <x-input-text value="{{ $collection_date }}"
                                                                            name="collection_date" placeholder=""
                                                                            type="date">
                                                                        </x-input-text>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4">
                                                                    <div class="mb-3">
                                                                        <label
                                                                            for="basicpill-lastname-input">Teacher:</label>
                                                                        <x-input-select :checked="$teacher_id"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="mb-3">
                                                                        <label for="basicpill-phoneno-input">Candidate
                                                                            ID:</label>
                                                                        <x-input-select :checked="$candidate_id"
                                                    ...
                                                    <div class="tab-pane" id="Pragmatic_Objective">
                                                        <section>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">Before birth</label>
                                                                <x-input-text :checked="$general->before_birth ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">Pregnancy</label>
                                                                <x-input-text :checked="$general->pregnancy ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">During Birth</label>
                                                                <x-input-text :checked="$general->during_birth ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">Delivery</label>
                                                                <x-input-text :checked="$general->delivery ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">After Birth</label>
                                                                <x-input-text :checked="$general->after_birth ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">History</label>
                                                                <x-input-text :checked="$general->history ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$general->medication_treatment ?? ''"
                                                                name="name" label="Medication Treatment"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$general->any_present_medicines ?? ''"
                                                                name="name" label="Any present medicines"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                    ...
                                                    <div class="tab-pane" id="PERSONAL">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->oral_motor ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->sucking ?? ''"
                                                                    name="name" label="Sucking"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->drooling ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->swollen ?? ''"
                                                                    name="name" label="Swollen"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->chewing ?? ''"
                                                                    name="name" label="Chewing"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->choking ?? ''"
                                                                    name="name" label="Choking"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$visual_perception->drinking ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="Topic_Maintenance">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$activities_of_daily_living->dressing ?? ''"
                                                                    name="name" label="Dressing"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$activities_of_daily_living->toilet ?? ''"
                                                                    name="name" label="Toilet"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$activities_of_daily_living->bathing ?? ''"
                                                                    name="name" label="Bathing"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$activities_of_daily_living->does_the_child_attend_school ?? ''"
                                                                    name="name" label="Does The Child attend school?"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <div class="mb-3">
                                                                    <label for="formrow-firstname-input"
                                                                        ...
                                                                        name</label>
                                                                    <x-input-text
                                                                        :checked="$activities_of_daily_living->if_yes_enter_school_name ?? ''"
                                                                        name="name" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$activities_of_daily_living->leisure_or_play_activities_of_interest ?? ''"
                                                                    name="name"
                                                                    label="Leisure/ Play: activities of interest."
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="formrow-firstname-input"
                                                                        ...
                                                                        strength area</label>
                                                                    <x-input-text
                                                                        :checked="$strength->please_explain_strength_area ?? ''"
                                                                        name="name" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                                <!-- end row -->
                                                    ...
                                                    <div class="tab-pane" id="Word_Structure">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->sitting ?? ''"
                                                                    name="name" label="Sitting"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->crawling ?? ''"
                                                                    name="name" label="Crawling"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->standing ?? ''"
                                                                    name="name" label="Standing"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->walking ?? ''"
                                                                    name="name" label="Walking"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->jumping ?? ''"
                                                                    name="name" label="Jumping"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->running ?? ''"
                                                                    name="name" label="Running"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$functional_gross_motor->ball_skill ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="Manner_Effectiveness">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->prone_to_supine ?? ''"
                                                                    name="name" label="Prone to Supine"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->continuous_rolling ?? ''"
                                                                    name="name" label="Continuous Rolling"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->lying_to_sit ?? ''"
                                                                    name="name" label="Lying to Sit"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->box_sit_to_stand ?? ''"
                                                                    name="name" label="Box sit to stand"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->jumping ?? ''"
                                                                    name="name" label="Jumping"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->cross_sit_to_stand ?? ''"
                                                                    name="name" label="Cross sit to stand"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$transitional_movements->kneeling_to_stand ?? ''"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="formrow-firstname-input"
                                                                        class="form-label">Right</label>
                                                                    <x-input-text
                                                                        :checked="$fine_motor_skill->right ?? ''"
                                                                        name="name" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    ...
                                                                    name="name" label="Reach"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$fine_motor_skill->release ?? ''"
                                                                    name="name" label="Release"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$fine_motor_skill->writing_skill ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_B">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$sensory_skill_normal_hypo_response->tactile ?? ''"
                                                                    name="name" label="Tactile"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$sensory_skill_normal_hypo_response->auditory ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$sensory_skill_normal_hypo_response->vestibular ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$sensory_skill_normal_hypo_response->proprioceptive ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_C">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->problem_solving ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->able_to_follow_instruction ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->memory ?? ''"
                                                                    name="name" label="Memory"
                                                                    :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->perceptual_motor ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->body_awareness ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->body_co_ordination ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$cognitive_skills->bilateral_integration ?? ''"
                                                        ...
                                                        <section>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    class="form-label">Treatment plan</label>
                                                                <x-input-text
                                                                    :checked="$treatment->treatment_plan ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    ...
                                                                    implementation details</label>
                                                                <x-input-text
                                                                    :checked="$treatment->treatment_plann ?? ''"
                                                                    name="name" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <!-- row end -->
                                                        ...
                                                        <section>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                                    ...
                                                                    Signature</label>
                                                                <x-input-text
                                                                    :checked="$signature->therapist_signature ?? ''"
                                                                    name="name" type="file" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="formrow-firstname-input"
                                                    ...
                                                    <div class="tab-pane" id="mp">
                                                        ...
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$muscle_power->lower_limbs ?? ''"
                                                    ...
                                                    <div class="tab-pane" id="mt">
                                                        ...
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$muscle_tone->lower_limbs ?? ''"
                                                                    name="name" label="Lower Limbs"
                                                                    :records="$physiotherapyConstants::$limbsTone">
                                                                </x-input-radio-or-check>
                                                                <div class="mb-3">
                                                    ...
                                                    <div class="tab-pane" id="Be">
                                                        <section>
                                                            ...
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$behavior->independence ?? ''" name="name"
                                                                label="Independence" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$behavior->social_interaction ?? ''"
                                                                name="name" label="Social interaction"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$behavior->social_communication ?? ''"
                                                                name="name" label="Social Communication"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$behavior->interpersonal ?? ''" name="name"
                                                                label="Interpersonal" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                    ...
                                                    <div class="tab-pane" id="DA">
                                                        <section>
                                                            ...
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$domain_area->cognitive ?? ''" name="name"
                                                                label="Cognitive" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <div class="mb-3">
                                                            ...
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$domain_area->communication ?? ''" name="name"
                                                                label="Communication" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$domain_area->social ?? ''" name="name"
                                                                label="Social" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$domain_area->emotional ?? ''" name="name"
                                                                label="Emotional" :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                    ...
                    <div id="vertical-example" class="vertical-wizard">
                        ...
                        <section>
                            <div>
                                <form>
                                    <!-- end row -->
                                    <x-input-radio-or-check name="name" label="Visual Discrimination"
                                        :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
                                    <!-- end row -->
                                    ...
                                    <!-- end row -->
                                    <!-- end row -->
                                    <x-input-radio-or-check name="name" label="Visual Figure ground"
                                        :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
                                    <!-- end row -->
                        ...
                        <section>
                            <div>
                                <form>
                                    ...
                                    <!-- end row -->
                                    <x-input-radio-or-check name="name" label="In-hand manipulation"
                                        :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
                                    <x-input-radio-or-check name="name" label="Eye hand co-ordination"
                                        :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
                                    <!-- end row -->
                        ...
                        <section>
                            <div>
                                <form>
                                    ...
                                    <!-- end row -->
                                    <!-- end row -->
                                    <x-input-radio-or-check name="name" label="Bilateral integration"
                                        :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
                                    <!-- end row -->
