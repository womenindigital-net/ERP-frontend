                                                ...
                                                <div id="wizard-navigation">
                                                    <ul class="wizard-navigation">
                                                        <li class="w-100"><a href="#SensoryChecklistYoungAdult"
                                                                ...
                                                                Young-Adult</a></li>
                                                        <li class="w-100"><a href="#TOUCH"
                                                                data-toggle="tab">TOUCH</a></li>
                                                        <li class="w-100"><a href="#PROPRIOCEPTION"
                                                                data-toggle="tab">PROPRIOCEPTION (BODY SENSE)</a>
                                                        </li>
                                                        <li class="w-100"><a href="#VESTIBULAR"
                                                                data-toggle="tab">VESTIBULAR (MOVEMENT SENSE)</a></li>
                                                        <li class="w-100"><a href="#AUDITORYLISTENING"
                                                                data-toggle="tab">AUDITORY/LISTENING</a></li>
                                                        <li class="w-100"><a href="#VISION"
                                                                data-toggle="tab">VISION</a></li>
                                                        <li class="w-100"><a href="#TASTEANDSMELL"
                                                                data-toggle="tab">TASTE AND SMELL</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="TOUCH">
                                                            <section>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="hugs_and_cuddles"
                                                                    label="Hugs and cuddles" :records="$sensoryChecklistConstant::$young">
                                                                </x-input-radio-or-check>
                                                                <!--end row -->
                                                                ...
                                                                <x-input-radio-or-check name="getting_hands"
                                                                    ...
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="taking_bath"
                                                                    label="Taking a bath, shower, or swimming"
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="getting_toweled_dry"
                                                                    label="Getting toweled dry" :records="$sensoryChecklistConstant::$young">
                                                                </x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="trying_new_foods"
                                                                    ...
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="standing_close"
                                                                    label="Standing close to other people"
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="walking_barefoot"
                                                                    label="Walking barefoot" :records="$sensoryChecklistConstant::$young">
                                                                </x-input-radio-or-check>
                                                                <!--end row -->
                                                            </section>
                                                        </div>
                                                        <div class="tab-pane" id="PROPRIOCEPTION">
                                                            <section>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="having_eyes"
                                                                    label="Having eyes closed or covered"
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                            </section>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane" id="AUDITORYLISTENING">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check name="unfamiliar_sounds"
                                                                    ...
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="singing_alone"
                                                                    label="Singing alone or with others" :records="$sensoryChecklistConstant::$young">
                                                                </x-input-radio-or-check>
                                                                <!--end row -->
                                                            </section>
                                                        </div>
                                                        <div class="tab-pane" id="VISION">
                                                            <section>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                    name="activities_that_require_eye-hand"
                                                                ...
                                                                <x-input-radio-or-check name="very_bright_light_or_sunshine"
                                                                    ...
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="dim_lighting"
                                                        ...
                                                        <div class="tab-pane" id="TASTEANDSMELL">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check
                                                                    ...
                                                                    :records="$sensoryChecklistConstant::$young"></x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check name="eating_new_foods"
                                                                    label="Eating new foods" :records="$sensoryChecklistConstant::$young">
                                                                </x-input-radio-or-check>
                                                                <!--end row -->
                                                                <x-input-radio-or-check
