                                                    ...
                                                    <div class="tab-pane" id="Pragmatic_Objective">
                                                        <section>
                                                            ...
                                                            <x-input-radio-or-check
                                                                ...
                                                                :checked="$speech->talk_too_loud_for_the_context??''"
                                                            ...
                                                            :checked="$speech->voice_is_too_hard??''"
                                                                :records="$constants::$yesNoEn"
                                                                secondaryInputLabel="Excessive:">
                                                            ...
                                                            :checked="$speech->voice_is_too_low??''"
                                                                :records="$constants::$yesNoEn"
                                                                secondaryInputLabel="Excessive:">
                                                            ...
                                                            label="Speech sounds monotone"
                                                            :checked="$speech->speech_sounds_monotone??''"
                                                                :records="$constants::$yesNoEn"
                                                                secondaryInputLabel="Excessive:">
                                                            ...
                                                            <!--end row -->
                                                            <x-input-radio-or-check
                                                             label="Speech sounds sign-song"
                                                            :checked="$speech->speech_sounds_sign_song??''"
                                                                :records="$constants::$yesNoEn"
                                                                secondaryInputLabel="Excessive:">
                                                    ...
                                                    <div class="tab-pane" id="PERSONAL">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$body_language->body_posture_is_too_rigid??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$body_language->body_posture_is_too_relaxed??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$body_language->has_noticed_nervous_mannerisms??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$body_language->has_limited_use_if_gestures??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check 
                                                                :checked="$body_language->eye_contact_is_fleeting??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check 
                                                                :checked="$body_language->does_not_use_eye_contact??''"
                                                    ...
                                                    <div class="tab-pane" id="Topic_Maintenance">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$words_usages_vocabulary->Has_difficulties_using??''"
                                                    ...
                                                    <div class="tab-pane" id="Repair_Structures">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$attention_and_memory->often_looks_away_or_??''"
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_B">
                                                        <section>
                                                            <div>
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->does_not_establish_joint_focus??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->has_difficulty_with_parallel_play??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->has_difficulty_with_associative_play??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->has_difficulty_with_cooperative_play??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->laughs_for_no_apparent_reason??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check
                                                                :checked="$play_skill->cries_for_no_apparent_reason??''"
                                                                ...
                                                                <!--end row -->
                                                                <x-input-radio-or-check 
                                                                :checked="$play_skill->has_difficulty_sharing??''"
