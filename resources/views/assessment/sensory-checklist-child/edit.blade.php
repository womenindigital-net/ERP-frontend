                        ...
                        <div class="col-sm-3 col-md-3">
                            <div id="wizard-navigation">
                                <ul class="wizard-navigation">
                                    <li class="w-100"><a href="#Sensory_Checklist" data-toggle="tab">Sensory
                                            Checklist</a></li>
                                    <li class="w-100"><a href="#Signs_Of_Tactile_Dysfunction" data-toggle="tab">Signs Of
                                            Tactile
                                            Dysfunction</a></li>
                                    <li class="w-100"><a href="#Hyposensitivity_To_Touch"
                                            data-toggle="tab">Hyposensitivity To
                                            Touch (Under-Responsive)</a></li>
                                    <li class="w-100"><a href="#Poor_Tactile_Perception_And_Discrimination"
                                            data-toggle="tab">Poor Tactile
                                            Perception And Discrimination</a>
                                    </li>
                                    <li class="w-100"><a href="#Signs_Of_Vestibular_Dysfunction" data-toggle="tab">Signs
                                            Of
                                    ...
                                    <li class="w-100"><a href="#Signs_Of_Vestibular_Dysfunction_Coordination"
                                            data-toggle="tab">Signs Of
                                            Vestibular Dysfunction > . Poor
                                            Muscle Tone And/Or Coordination</a>
                                    </li>
                                    <li class="w-100"><a href="#Signs_Of_Vestibular_Dysfunction_Behaviors"
                                            data-toggle="tab">Signs Of
                                            Proprioceptive Dysfunction > Sensory
                                            Seeking Behaviors</a></li>
                                    <li class="w-100"><a href="#Signs_Of_Vestibular_Dysfunction_Movement"
                                            data-toggle="tab">Signs Of
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            <label for="basicpill-phoneno-input">Candidate
                                                                ID:</label>
                                                            <x-input-select :selected="$student_id" name="student_id"
                                                                :records="$students">
                                                            </x-input-select>
                                                        </div>
                                                    </div>
                                        ...
                                        <section>
                                            <div>
                                                <form>
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Maybe_afraid_of_the_dark"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Looks_disheveled"
                                                        label="Looks disheveled" :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Does_not_notice_pants"
                                                        label="Does not notice pants are twisted"
                                                        :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Shirt_is_half_un_tucked"
                                                        label="Shirt is half un tucked" :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Shoes_are_untied"
                                                        label="Shoes are untied" :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="One_pant_leg_is_up_and_one_is_down"
                                                        label="One pant leg is up and one is down"
                                                        :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Has_difficulty_using_scissors"
                                                        label="Has difficulty using scissors"
                                                        :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                                    <x-input-radio-or-check name="Crayons_or_silverware"
                    ...
                    <section>
                        <div>
                            <form>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name="" label="Looks disheveled"
                                    :records="$constants::$yesNoEn">
                                </x-input-radio-or-check>
                                <!-- end row -->
