                                                    ...
                                                    <div class="tab-content apply-view-only">
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Tactile_Dysfunction">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$signs_of_tactile_dysfunction->distressed_about_having_hair ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="Hyposensitivity_To_Touch">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->may_crave_touch ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->is_not_aware_of_being_touched ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->is_not_bothered_by_injuries ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->may_not_be_aware_that_hands ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->may_be_self_abusive ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->mouths_objects_excessively ??
                                                                    ''"
                                                                    name="mouths_objects_excessively"
                                                                    label="Mouths objects excessively" :records="$constants::$yesNoEn">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->frequently_hurts ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->repeatedly_touches_surfaces ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->seeks_out_surfaces ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->thoroughly_enjoys_and_seeks_out_messy_play ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$hyposensitivity_to_touch->craves_vibrating_or_strong_sensory_input ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->has_difficulty_with_fine_motor ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->may_not_be_able_to_identify ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->maybe_afraid_of_the_dark ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->may_be_a_messy_dresser ??
                                                                        ''"
                                                                        name="may_be_a_messy_dresser"
                                                                        label="May be a messy dresser" :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->looks_disheveled ??
                                                                        ''"
                                                                        name="looks_disheveled" label="Looks disheveled"
                                                                        :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->does_not_notice_pants_are_twisted ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->shirt_is_half_un_tucked ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->shoes_are_untied ??
                                                                        ''"
                                                                        name="shoes_are_untied" label="Shoes are untied"
                                                                        :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->one_pant_leg_is_up_and_one_is_down ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->has_difficulty_using_scissors ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->crayons_or_silverware ??
                                                                        ''"
                                                                        name="crayons_or_silverware"
                                                                        label="Crayons, or silverware" :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->continues_to_mouth_objects ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$poor_tactile_perception_and_discrimination->has_difficulty_figuring_out ??
                                                                        ''"
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Vestibular_Dysfunction">
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->avoids_dislikes_playground_equipment ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->prefers_sedentary_tasks ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->avoids_dislikes_elevators ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->may_physically_cling_to_an_adult_they_trust ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->may_appear_terrified_offalling_even ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->afraid_of_heights ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->fearful_of_feet ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->Fearful_of_going_up ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->afraid_of_being_tipped_upside_down ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->startles_if_someone_else_moves_them ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->as_an_infant ??
                                                                        ''"
                                                                        name="as_an_infant"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->may_be_fearful_of ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->may_have_disliked_being_placed ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->loses_balance_easily ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->Fearful_of_activities ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction->Avoids_rapid_or_rotating_movements ??
                                                                        ''"
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Vestibular_Dysfunction_under">
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->in_constant_motion_cant_seem_to_sit_still ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->craves_fast ??
                                                                        ''"
                                                                        name="craves_fast"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->loves_being_tossed_in_the_air ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->could_spin_for_hours ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->loves_the_fast ??
                                                                        ''"
                                                                        name="loves_the_fast"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->always_jumping_on_furniture ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->loves_to_swing_as_high_as_possible ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->is_a_thrill_seeker ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->always_running ??
                                                                        ''"
                                                                        name="always_running"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->rocks_body ??
                                                                        ''"
                                                                        name="rocks_body"
                                                                        label="Rocks body, shakes leg, or head while sitting"
                                                                        :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->Avoids_rapid_or_rotating_movements ??
                                                                        ''"
                                                                        name="" label="demo" :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>

                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_under->likes_sudden ??
                                                                        ''"
                                                                        name="likes_sudden"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->difficulty_simultaneously_lifting_head ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->often_sits_in_a ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->fatigues_easily ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->difficulty_turning_doorknobs ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->difficulty_catching_him ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->difficulty_getting_dressed_and_doing_fasteners ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->may_have_never_crawled_as_an_baby ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->has_poor_body_awareness ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->poor_gross_motor_skills ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->poor_fine_motor_skills ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->may_appear_ambidextrous ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->has_difficulty_licking ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->seems_to_be_unsure_about ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_coordination->difficulty_learning_exercise ??
                                                                        ''"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->seeks_out_jumping_bumping ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->stomps_feet_when_walking ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->kicks_his_her_feet_on_floor_or_chair_while_sitting_at_desk_table ??
                                                                        ''"
                                                                        name=""
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->bites_or_sucks_on_fingers_and ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->loves_to_be_tightly_wrapped ??
                                                                        ''"
                                                                        name=""
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->prefrs_clothees ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->may_not_understand_the_idea ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->loves_or_seeks_out ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->enjoys_bear_hugs ??
                                                                        ''"
                                                                        name="enjoys_bear_hugs" label="Enjoys bear hugs"
                                                                        :records="$constants::$yesNoEn">
                                                                    </x-input-radio-or-check>
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->excessive_banging ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->loves_roughhousing_and_tackling ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->frequently_falls_on_floor_intentionally ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->would_jump_on_a_trampoline ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->grinds_his_her_teeth_throughout_the_day ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->loves_pushing_pulling ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->loves_jumping_off_furniture ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->frequently_hits ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_behaviors->chews_on_pens ??
                                                                        ''"
                                                                        name="chews_on_pens"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                <div>
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->misjudges_how_much_to_flex ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->difficulty_regulating_pressure ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->kicks_his_her_feet_on_floor ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->written_work_is_messy ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->always_seems_to_be_breaking ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->misjudges_the_weight_of_an_object ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->may_not_understand_the_idea_of ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->seems_to_do_everything_with ??
                                                                        ''"
                                                                    ...
                                                                    <!-- end row -->
                                                                    <x-input-radio-or-check :checked="$signs_of_vestibular_dysfunction_movement->plays_with_animals ??
                                                                        ''"
