                                                        ...
                                                        <section>
                                                            <form>
                                                                <x-input-radio-or-check name="hazar_spotted/Type" type="checkbox"
                                                                    label="Hazard spotted/Type" :records="$IRAConstants::$riskAssessment" :isVertical="false"></x-input-radio-or-check>
                                                                <!-- end row -->
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check name="accident"
                                                                ...
                                                                {{-- end row --}}
                                                                <x-input-radio-or-check name="consequences" label="Consequences"
                                                                ...
                                                                <div class="row border-top py-2">
                                                                    <div class="col-xl-12 col-sm-12">
                                                                        <div class="m-0">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <x-input-text name="signatur_of_support_worker"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div id="vertical-example" class="vertical-wizard">
                                        ...
                                        <section>
                                            <form>
                                                <x-input-radio-or-check name="hazard_spotted" type="checkbox" label="Hazard spotted/Type"
                                                ...
                                                <div class="row border-top py-2">
                                                    <div class="col-xl-12 col-sm-12">
                                                        <div class="m-0">
                                                            <h5>Level of risk (1-25)</h5>
                                                            <div class="mb-2">
                                                                <x-input-text name="level_of_risk" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <x-input-radio-or-check name="likelihood" label="Likelihood" :records="$IRAConstants::$likelihood">
                                                </x-input-radio-or-check>
                                                {{-- end row --}}
                                                <x-input-radio-or-check name="consequences" label="Consequences" :records="$IRAConstants::$consu">
                                                </x-input-radio-or-check>
                                                {{-- end row --}}
                                                ...
                                                <div class="row border-top py-2">
                                                    <div class="col-xl-12 col-sm-12">
                                                        <div class="m-0">
                                                            <h5>Staff signature</h5>
                                                            <div class="mb-2">
                                                                <x-input-text name="staff_signature" placeholder="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row border-top py-2">
                                                    <div class="col-xl-12 col-sm-12">
                                                        <div class="m-0">
                                                            <h5>Signature of support worker</h5>
                                                            <div class="mb-2">
                                                                <x-input-text name="signature" placeholder="">
                                                                </x-input-text>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row border-top py-2">
                                                    <div class="col-xl-12 col-sm-12">
                                                        <div class="m-0">
                                                            <h5>Support worker name</h5>
                                                            <div class="mb-2">
                                                                <x-input-text name="support_worker" placeholder=""></x-input-text>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
