                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="Pragmatic_Objective">
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$pragmatic_objective->ability_to_interact_with_many_individuals_simultaneously ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$pragmatic_objective->understanding_sharing_and_the_concept_of_give_and_take ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Conversational_Structure">
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$conversational_structure->ability_to_establish_a_conversation_outside_of_the_interest_area ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$conversational_structure->ability_to_delete_redundant_information_appropriately ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Repair_Structures">
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$repair_structures->requests_repetition_of_information_for_clarification_purposes ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_D">
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$prosody->ability_to_comprehend_implied_meanings_via_tone_of_voice ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$prosody->ability_to_comprehend_implied_meanings_via_inflectional_cues ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_F">
                                                        <section>
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$style_of_Conversation->ability_to_shift_the_style_of_conversation_according_to_person ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$style_of_Conversation->ability_to_shift_the_style_of_conversation_according_to_the_setting ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$style_of_Conversation->ability_to_shift_the_style_of_conversation_according_to_humor ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Functional_Intent_H">
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$greetings_acknowledgements->ability_to_acknowledge_the_presence_of_another_individual ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="Academic_Communication">
                                                        ...
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$academy_communication->ability_to_respond_appropriately_to_teacher_requests ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$academy_communication->ability_to_reorient_to_academic_agenda_appropriately ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$academy_communication->ability_to_obtain_teachers_attention_appropriately ?? ''"
                                                                name=""
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$academy_communication->ability_to_respond_to_questions_requiring_inferential_reasoning ?? ''"
                                                                name=""
                                                    ...
                                                    <div class="tab-pane" id="REGULATORY">
                                                        ...
                                                        <section>
                                                            ...
                                                            <!-- row end -->
                                                            <x-input-radio-or-check
                                                                :checked="$regulatory_gives_commands->changes_the_style_of_commands_or_requests_depending_on_who_the_child_is_speaking_to_and_what_the_child_wants ?? ''"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="vertical-example" class="vertical-wizard">
                    ...
                    <section>
                        <x-input-radio-or-check name="" label="Interaction with adults "
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Aggressive tendencies"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Relevancy of information"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Use of pedantic speech"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                    </section>
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Use of word referents"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Makes polite requests"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Uses humor appropriately"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                    </section>
                    ...
                    <section>
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Uses language to deceive"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Ability to use eye gaze"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Ability to use gestures"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
                    ...
                    <section>
                        ...
                        <!-- row end -->
                        <x-input-radio-or-check name="" label="Perfectionist quality"
                            :records="$constants::$socialCommunication" :isVertical="false">
                        </x-input-radio-or-check>
                        <!-- row end -->
