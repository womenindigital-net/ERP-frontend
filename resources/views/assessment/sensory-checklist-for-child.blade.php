                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#profile" role="tab">
                                                    ...
                                                    <span class="d-none d-sm-block">Care Needs Form Dtails</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!-- Tab panes -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <p>Parents can use this checklist to identify potential sensory challenges for
                                                their Child. The
                                                checklist is designed to target specific areas of potential dysfunction and
                                                to give you an
                                                opportunity to look at child’s environment and assess potential triggers for
                                                challenging
                                                behaviors. Read the statements and put a check mark or an X next to any
                        ...
                        <section>
                            <div>
                                <form>
                                    ...
                                    <!-- end row -->
                                    <x-input-radio-or-check name=""
                                        label="Always running, jumping, hopping etc. instead of walking" :records="$constants::$yesNoEn">
                                    </x-input-radio-or-check>
                                    <!-- end row -->
