                                                    ...
                                                    <div class="tab-pane" id="General">
                                                        <section>
                                                            ...
                                                            <x-input-radio-or-check name="name"
                                                                label="Separate Home equipment"
                                                                :records="$constants::$yesNoEn">
                                                            </x-input-radio-or-check>
                                                            <!-- row end -->
                                                            <x-input-radio-or-check name="name" label="Communication"
                                    ...
                                    <div class="row">
                                        <div class="form-check">
                                            <div class="me-5 ">
                                                ...
                                                <x-input-text name="collection_date" placeholder="Medication Treatment">
                                                </x-input-text>
                                            </div>
                                            <div class="me-5 ">
                                ...
                                <div id="wizard-navigation">
                                    <ul class="wizard-navigation">
                                        <li class="w-100"><a href="#Occupational_Therapy" data-toggle="tab">Occupational
                                                Therapy</a></li>
                                        <li class="w-100"><a href="#General" data-toggle="tab">General</a></li>
                                        <li class="w-100"><a href="#Muscle_Tone" data-toggle="tab">Muscle Tone</a></li>
                                                ...
                                                <form>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 pull-left pb-2">
                                                            <label class="p-2">Teacher: <span
                                                                    class="text-danger text-bold">*</span></label>
                                                            <select class="form-control strip-tags select2" id="Teacher"
                                                            ...
                                                            <div class="row">
                                                                <div class="form-check">
                                                                    <div class="me-5 ">
                                                                        <label
                                                                            class="form-check-label pb-2">Left</label>
                                                                        <x-input-text name="name" placeholder="Left">
                                                                        </x-input-text>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <label
                                                                            class="form-check-label pb-2">Right</label>
                                                                        <x-input-text name="name" placeholder="Right">
                                                                        </x-input-text>
                                                                    </div>
                                                                </div>
                                                            </div>
