                            ...
                            <div class="col-lg-12">
                                <div class="accordion" id="accordionExample">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox" name="organized_play[]">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapsefoure" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="fitness_physical_activity[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingA">
                                            <button class="accordion-button collapsed" type="button"
                                               ...
                                               Section F: Domain 02 : Intellectual / cognitive development > Sensory Skills > Sex education > Body Awareness
                                            </button>
                                        </h2>
                                        <div id="collapseA" class="accordion-collapse collapse"
                                            aria-labelledby="headingA" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingB">
                                            <button class="accordion-button collapsed" type="button"
                                              ...
                                              Section F: Domain 02 : Intellectual / cognitive development > Sensory Skills > Sex education > Physical Growth
                                            </button>
                                        </h2>
                                        <div id="collapseB" class="accordion-collapse collapse"
                                            aria-labelledby="headingB" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingC">
                                            <button class="accordion-button collapsed" type="button"
                                             ...
                                             Section F: Domain 02 : Intellectual / cognitive development > Sensory Skills > Sex education > Good touch/bad touch
                                            </button>
                                        </h2>
                                        <div id="collapseC" class="accordion-collapse collapse"
                                            aria-labelledby="headingC" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseD" class="accordion-collapse collapse"
                                            aria-labelledby="headingD" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseE" class="accordion-collapse collapse"
                                            aria-labelledby="headingE" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="generalization_ability[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseF" class="accordion-collapse collapse"
                                            aria-labelledby="headingF" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="functional_reading_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                ...
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="functional_reading_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                       Own address and telephone number Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingG">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Functional Academic Skills > Writing : Includes Fine motor skills
                                            </button>
                                        </h2>
                                        <div id="collapseG" class="accordion-collapse collapse"
                                            aria-labelledby="headingG" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="includes_fine_motor_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingH">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Functional Academic Skills > Time Skill
                                            </button>
                                        </h2>
                                        <div id="collapseH" class="accordion-collapse collapse"
                                            aria-labelledby="headingH" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="time_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                      Demonstrate an understanding of time concepts, before, after, yesterday, today, tomorrow, ETC Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="time_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                     Understand and accept ‘work times’ and ‘relax times’ of day Type: Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingI">
                                            <button class="accordion-button collapsed" type="button"
                                              ...
                                              Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Respond
                                            </button>
                                        </h2>
                                        <div id="collapseI" class="accordion-collapse collapse"
                                            aria-labelledby="headingI" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingJ">
                                            <button class="accordion-button collapsed" type="button"
                                              ...
                                              Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Verbs
                                            </button>
                                        </h2>
                                        <div id="collapseJ" class="accordion-collapse collapse"
                                            aria-labelledby="headingJ" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingL">
                                            <button class="accordion-button collapsed" type="button"
                                             ...
                                             Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Listening skills
                                            </button>
                                        </h2>
                                        <div id="collapseL" class="accordion-collapse collapse"
                                            aria-labelledby="headingL" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="listening_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingM">
                                           ...
                                           Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Request
                                            </button>
                                        </h2>
                                        <div id="collapseM" class="accordion-collapse collapse"
                                            aria-labelledby="headingM" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingN">
                                           ...
                                           Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Speaking
                                            </button>
                                        </h2>
                                        <div id="collapseN" class="accordion-collapse collapse"
                                            aria-labelledby="headingN" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingO">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Section F: Domain 02 : Intellectual / cognitive development > Skill Development planner > Communication Skills > Pragmatic communication
                                            </button>
                                        </h2>
                                        <div id="collapseO" class="accordion-collapse collapse"
                                            aria-labelledby="headingO" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="pragmatic_communication[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                         Ask for a break when feeling stress/upset Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingP">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Section F: Domain 02 : Intellectual / cognitive development > Independent Daily Living Skills > Life Skills (Following ADLs) > Hygiene: Washing & Showering
                                            </button>
                                        </h2>
                                        <div id="collapseP" class="accordion-collapse collapse"
                                            aria-labelledby="headingP" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="washing_showering[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseQ" class="accordion-collapse collapse"
                                            aria-labelledby="headingQ" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="basic_first_aid_knowledgee[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseR" class="accordion-collapse collapse"
                                            aria-labelledby="headingR" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="preparation_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                         Make simple snacks for oneself Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingS">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="collapseS">
                                                 Section F: Domain 02 : Intellectual / cognitive development > Independent Daily Living Skills > Meal preparation skills & Knowledge > Cooking preparation
                                            </button>
                                        </h2>
                                        <div id="collapseS" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="cooking_preparation[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseT" class="accordion-collapse collapse"
                                            aria-labelledby="headingT" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingU">
                                            <button class="accordion-button collapsed" type="button"
                                               ...
                                               Section G : Domain 03 - Emotional development > Behavior Management > Intrapersonal > Prompting
                                            </button>
                                        </h2>
                                        <div id="collapseU" class="accordion-collapse collapse"
                                            aria-labelledby="headingU" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="prompting[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                      Helping teacher to response correctly. Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingV">
                                            <button class="accordion-button collapsed" type="button"
                                              ...
                                              Section G : Domain 03 - Emotional development > Behavior Management > Intrapersonal > Modeling
                                            </button>
                                        </h2>
                                        <div id="collapseV" class="accordion-collapse collapse"
                                            aria-labelledby="headingV" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingX">
                                            <button class="accordion-button collapsed" type="button"
                                             ...
                                             Section H : Domain 04 - Social and ethical development > Social Emotional Learning (SEL) > Interpersonal Skills > Emotions
                                            </button>
                                        </h2>
                                        <div id="collapseX" class="accordion-collapse collapse"
                                            aria-labelledby="headingX" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="emotions[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                      Demonstrate appropriate ways to manage uncomfortable emotions Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="emotions[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                      Express own emotion appropriately Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="emotions[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                      Know uncomfortable emotions such as anger, fear, guilt, anxiety & stress, ETC. Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingW">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Section H : Domain 04 - Social and ethical development > Social Emotional Learning (SEL) > Interpersonal Skills > Social Awareness
                                            </button>
                                        </h2>
                                        <div id="collapseW" class="accordion-collapse collapse"
                                            aria-labelledby="headingW" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="social_awareness[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                       Understanding about private, personal and social areas / places Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseY" class="accordion-collapse collapse"
                                            aria-labelledby="headingY" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="interpersonal_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                             ...
                                             <div class="form-check form-check-info mb-3">
                                                 ...
                                                 <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="interpersonal_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                       Make eye contact when spoken to Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="interpersonal_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                       Smile in response to a social greeting Type: Pre-Vocational 
                                                    </label>
                                                </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseZ" class="accordion-collapse collapse"
                                        aria-labelledby="headingZ" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="form-check form-check-info mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    id="formCheckcolor3" name="games_how_to_play_with_others[]">
                                                <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <h2 class="accordion-header" id="headingZZ">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="collapseZZ">
                                             Section H : Domain 04 - Social and ethical development > Social Communication skills > Social Interaction > Sharing Personal issues
                                        </button>
                                    </h2>
                                    <div id="collapseZZ" class="accordion-collapse collapse"
                                        aria-labelledby="headingZZ" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="form-check form-check-info mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    id="formCheckcolor3" name="sharing_personal_issues[]">
                                                <label class="form-check-label" for="formCheckcolor3">
                                                   Turn taking Type: Pre-Vocational 
                                                </label>
                                            </div>
                            ...
                            <!-- Single item  -->
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAA" class="accordion-collapse collapse"
                                        aria-labelledby="headingAA" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="form-check form-check-info mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    id="formCheckcolor3" name="self_development[]">
                                                <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapsesix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="fundamental_movement_exercisel[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseeight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="craft_activities[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseten" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="functional_reading_skillss[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseeleven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="money_management_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapsetwelve" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="shaving_routing[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse13" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="basic_first_aid_knowledge[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse14" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="meal_preparation_skills[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse16" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="self_awareness_intrapersonal[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                        Make small decisions independently Type: Vocational
                                                    </label>
                                                </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse17" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3"  name="self_esteem_intrapersonal[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse18" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="self_regulation_intrapersonal[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse19" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="managing_death_of_family_members[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                        Self – Calming strategies Type: Vocational
                                                    </label>
                                                </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse20" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="managing_death_of_relative_friends[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                                        Share personal exhausting feelings. Type: Vocational
                                                    </label>
                                                </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse22" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="handle_accept_different_situation[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse23" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="understand_social_deviation[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse24" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="how_to_play_with_others[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse26" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="ethical_values[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse27" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3"  name="work_readiness_ethical_values[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse28" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="home_maintenance_self_development[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse29" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="cleaning_washing_chores_self_development[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse30" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="form-check form-check-info mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="formCheckcolor3" name="telephone_skills_self_development[]">
                                                    <label class="form-check-label" for="formCheckcolor3">
