                ...
                <div class="card-body p-0">
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="case-histroy" role="tabpanel">
                            <form action="{{ route('create-itp.store') }}" method="post">
                                @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-12 row">
                                                    <div class="col-2">
                                                        <button class="btn btn-primary accordion-button collapsed"
                                                            type="button" data-bs-toggle="collapse"
                                                            data-bs-target=".collapse" aria-expanded="true"
                                                            aria-controls="collapse">Collapse</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="accordion" id="accordionExample">
                                                                ...
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input class="form-check-input"
                                                                            name="personal_work[]" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapsesix" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="meal_preparetion_skill[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapsenine" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="therapeutic_homework[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingB">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Intrapersonal > Loss of relationship > managing death of
                                                                    family members
                                                                </button>
                                                            </h2>
                                                            <div id="collapseB" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_g[]" class="form-check-input"
                                                                            type="checkbox" id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Checkbox Info
                                                                        </label>
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapse21" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_interpersonal_skill[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading22">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical development >
                                                                    Social Emotional Learning (SEL) > Perspective taking >
                                                                    Handle/accept different situation
                                                                </button>
                                                            </h2>
                                                            <div id="collapse22" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_different_situation[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading23">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical development >
                                                                    Social Emotional Learning (SEL) > Empathy > Understand
                                                                    social deviation in terms of age
                                                                </button>
                                                            </h2>
                                                            <div id="collapse23" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_termsof_age[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Understand, follow and maintain the acceptable
                                                                            and unacceptable behaviors Type: Vocational
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_termsof_age[]"
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            ...
                                                                            group of people. Type: Vocational
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapse24" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_play_with_others[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapse25" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_social_interection[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Makes apologies or gives explanations of
                                                                            behavior Type: Vocational
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading26">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical development >
                                                                    Work Habit > Communication (work related) > Ethical
                                                                    Values
                                                                </button>
                                                            </h2>
                                                            <div id="collapse26" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_ethical_values[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading27">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical development >
                                                                    Work Habit > Work Readiness > Ethical Values
                                                                </button>
                                                            </h2>
                                                            <div id="collapse27" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_work_habit_ethical_values[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Be comfortable with getting temporarily
                                                                            interrupted Type: Vocational
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingV">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    skills > Home Maintenance > Self development
                                                                </button>
                                                            </h2>
                                                            <div id="collapseV" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_self_development[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading28">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section I: Independent skills > Household maintenance
                                                                    skills > Cleaning & Washing Chores > Self development
                                                                </button>
                                                            </h2>
                                                            <div id="collapse28" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_cleaning_selfdevelopment[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading29">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section I: Independent skills > Household maintenance
                                                                    skills > Telephone Skills > Self development
                                                                </button>
                                                            </h2>
                                                            <div id="collapse29" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        <input name="section_telephone_selfdevelopment[]"
                                                                            class="form-check-input" type="checkbox"
                                                                            id="formCheckcolor3">
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
