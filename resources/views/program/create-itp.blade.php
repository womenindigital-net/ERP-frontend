                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row pb-3">
                                                <div class="col-6 d-flex">
                                                    <label for="example-date-input"
                                                        class="col-md-4 col-form-label">Start Date</label>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="row pb-3">
                                                ...
                                                <div class="col-6 mt-4 border border-2">
                                                    <div class="fw-bold">Section E: Domain 01 - Physical development :
                                                                ...
                                                                <form class="repeater" enctype="multipart/form-data">
                                                                    ...
                                                                    <div data-repeater-list="group-a">
                                                                        <div data-repeater-item class="row">
                                                                            <div
                                                                                class="col-lg-3 d-flex p-0 pe-1 pb-1 align-items-center">
                                                                                <span class="pe-2 pb-1">01</span>
                                                                                <p class="form-control">Cut on a line
                                                                                </p>
                                                                            </div>
                                                                            ...
                                                                            <div class=" col-lg-3 p-0 pe-1 pb-1">
                                                                                <select id="formrow-inputState"
                                                                                    ...
                                                                                    <option value="1">09:00:AM -
                                                                                        09:15:AM - Assembly</option>
                                                                                    <option value="2">09:15:AM -
                                                                                        10:30:AM - Breakfast</option>
                                                                                    <option value="3">10:30:AM -
                                                                                        01:30:PM - Follow ITP ( focus on
                                                                                        ADL ), therapy/ gym / exercise
                                                                                    </option>
                                                                                    <option value="4">01:30:PM -
                                                                                        02:15:PM - Lunch</option>
                                                                                    <option value="5">02:15:PM -
                                                                                        02:45:PM - Rest</option>
                                                                                    <option value="6">02:45:PM -
                                                                                        04:45:PM - Cultural Activity /
                                                                                        Continue Vocational work
                                                                                    </option>
                                                                                    <option value="7">04:45:PM -
                                                                                        05:00:PM - Snacks</option>
                                                                                    <option value="8">05:00:PM -
                                                                                        05:00:PM - Return Home</option>
                                                                                </select>
                                                                            </div>
                                                                            <div
                                                    ...
                                                    <div class="accordion" id="accordionExample">
                                                            ...
                                                            <div id="collapseTwo" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="form-check form-check-info mb-3">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Watching movie and television show with
                                                                            family
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingB">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Intrapersonal > Loss of relationship > managing
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading21">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading22">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Social Emotional Learning (SEL) >
                                                                    Perspective taking > Handle/accept different
                                                                    situation
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading23">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Social Emotional Learning (SEL) >
                                                                    Empathy > Understand social deviation in terms of
                                                                    age
                                                                </button>
                                                            </h2>
                                                            <div id="collapse23" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Understand, follow and maintain the
                                                                            acceptable and unacceptable behaviors Type:
                                                                            Vocational
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-check form-check-info mb-3">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Understand the responsibility towards all
                                                                            age group of people. Type: Vocational
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading24">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Leisure & Recreation > Social games >
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading25">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Social Communication skills > Social
                                                                    Interaction > Interactional - Me and You…
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading26">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Work Habit > Communication (work
                                                                    related) > Ethical Values
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading27">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section H : Domain 04 - Social and ethical
                                                                    development > Work Habit > Work Readiness > Ethical
                                                                    Values
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingV">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#collapseV" aria-expanded="false"
                                                                    aria-controls="collapseV">
                                                                    Section I: Independent skills > Household
                                                                    maintenance skills > Home Maintenance > Self
                                                                    development
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading28">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section I: Independent skills > Household
                                                                    maintenance skills > Cleaning & Washing Chores >
                                                                    Self development
                                                                </button>
                                                            </h2>
                                                        ...
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="heading29">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    Section I: Independent skills > Household
                                                                    maintenance skills > Telephone Skills > Self
                                                                    development
                                                                </button>
                                                            </h2>
                                                            <div id="collapse29" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="form-check form-check-info mb-3">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="formCheckcolor3">
                                                                            Relay simple telephone messages Type:
                                                                            Vocational
                                                                        </label>
                                                                    </div>
                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>first to last</td>
                            <td>demo</td>
                            <td><i class="fas fa-eye pe-3"></i> <i class="fas fa-check pe-3"></i> <i
                                    class="fas fa-pen pe-3"></i><i class="fas fa-trash-alt"></i></td>
                        </tr>
                        <tr>
                            <td>demo</td>
                            <td>demo</td>
