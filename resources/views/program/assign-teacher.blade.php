                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select name="IsMainTeacher" onchange="activeMainTeacher(this)" class="form-control strip-tags  form-control section2 form-select" id="IsMainTeacher" required="">
                                                                    <option value="">Select</option>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger btn-rounded waves-effect waves-light mb-2"> <i
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" value="Iaffee Hossain Dipto" id="example-text-input">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
