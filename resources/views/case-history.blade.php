                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4">
                                  <div class="mb-3">
                                    ...
                                    <x-input-select name="sample" :records="$teachers" name="teacher_id">
                                    </x-input-select>
                                  </div>
                                </div>
                                <div class="col-lg-4">
                          ...
                          <div class="tab-pane" id="referralInformation">
                            <section>
                              ...
                              <x-input-radio-or-check
                                ...
                                :records="$constants::$yesNo" name="has_adjustment_capability">
                              </x-input-radio-or-check>
                              <!-- end row -->
                          ...
                          <div class="tab-pane" id="HistoryOfDevelopment">
                            <section>
                              <div>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name='dose_have_balancing_problem'
                          ...
                          <div class="tab-pane" id="LanguageSkills">
                            <section>
                              <div>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name='is_able_spake_simple_sentence'
                          ...
                          <div class="tab-pane" id="Self-reliance">
                            <section>
                              <div>
                                ...
                                <!-- end row -->
                                <x-input-radio-or-check name='does_move' label="ঘোরাঘুরি করে"
                                  :records="$constants::$yesNo">
                                </x-input-radio-or-check>
                                <!-- end row -->
