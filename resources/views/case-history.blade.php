                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="LearningSkills">
                                                            ...
                                                            <div class="tab-pane" id="Self-reliance">
                                                                <section>
                                                                    <div>
                                                                        <p>আপনার সন্তানের মাঝে নিচের বিষয়গুলির নিয়ে কোন
                                                                            অসুবিধা পরিলক্ষন করেছেন কি? করে থাকলে,
                                                                            কমেন্টে বিস্তারিত
                                                                            লিখুন। এই বিষয়গুলি মুলত স্কুলে যাওয়ার বয়সের
                                                                            জন্য প্রযোজ্যঃ</p>
                                                                        <!-- end row -->
                                                                        <x-input-radio-or-check
                                                                        ...
                                                                        <!-- end row -->
                                                                        <x-input-radio-or-check name='mobility'
                                                                                                label="মবিলিটি"
                                                                                                type="checkbox"
