                                        ...
                                        <div id="wizard-navigation">
                                            <ul class="wizard-navigation">
                                                ...
                                                <li class="w-100"><a href="#Self-reliance"
                                                        data-toggle="tab">স্বনির্ভরতা</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-content apply-view-only">
                                                ...
                                                <div class="tab-pane" id="referralInformation">
                                                    <section>
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check :checked="$caseHistory->has_past_assessment_by_specialist" :secondaryInputValue="$caseHistory->has_past_assessment_by_specialist_secondary"
                                                    ...
                                                    <section>
                                                        <div>
                                                            ...
                                                            <x-input-radio-or-check name='can_use_language_correctly'
                                                                ...
                                                                :records="$constants::$yesNo" :checked="$caseHistory->can_use_language_correctly">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                    ...
                                                    <section>
                                                        <div>
                                                            ...
                                                            <x-input-radio-or-check :checked="$caseHistory->bath" name='bath'
                                                                ...
                                                                secondaryInputLabel="বিস্তারিত লিখুন" :secondaryInputValue="$caseHistory->bath_secondary"
                                                            ...
                                                            <x-input-radio-or-check :checked="$caseHistory->necessary_things"
                                                                ...
                                                                secondaryInputLabel="বিস্তারিত লিখুন" :isVertical="false"
                                                                :multiple="true" :secondaryInputValue="$caseHistory->necessary_things_secondary">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            ...
                                                            <x-input-radio-or-check name='staying_in_motion_all_the_time'
                                                                :checked="$caseHistory->staying_in_motion_all_the_time" label="সারাক্ষণ নড়াচড়ার মধ্যে থাকে?"
                                                                :records="$constants::$yesNo">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
