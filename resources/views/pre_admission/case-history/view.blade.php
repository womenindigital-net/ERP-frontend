                      ...
                      <div class="tab-pane" id="referralInformation">
                        <section>
                          ...
                          <x-input-radio-or-check :checked="$caseHistory->has_control_over_body"
                            name="has_control_over_body" label="শরীরের ওপর সাধারণ নিয়ন্ত্রন আছে কিনা?"
                            :records="$constants::$yesNo">
                          </x-input-radio-or-check>

                          <!-- end row -->
                          <x-input-radio-or-check :checked="$caseHistory->has_speaking_problem"
                            name="has_speaking_problem" label="কথা বলার সমস্যা আছে কিনাঃ" :records="$constants::$yesNo"
                        ...
                        <section>
                          <div>
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->is_able_to_swimming"
                              name='is_able_to_swimming' label="শিশু কি সাঁতার জানে ?" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->dose_get_tired_soon"
                              name='dose_get_tired_soon' label="শিশু কি খুব সহজেই. ক্লান্ত হয়ে যায়?"
                              :records="$constants::$yesNo" secondaryInputLabel="বিস্তারিত লিখুন">
                            </x-input-radio-or-check>
                            <!-- end row -->
                        ...
                        <section>
                          <div>
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->dose_spake_in_other_lang"
                              name='dose_spake_in_other_lang' label="অন্য কোন ভাষায় কথা বলতে পারে কি?"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check> --}}
                            <!-- end row -->
                            <x-input-radio-or-check :checked="$caseHistory->dose_spake_in_other_lang"
                          ...
                          <div>
                            ...
                            <div class="row border-top py-2">
                              ...
                              <x-input-radio-or-check :checked="$caseHistory->can_write_himself"
                                name='can_write_himself' label="নিজে নিজে লিখতে পারে?" :records="$constants::$yesNo">
                              </x-input-radio-or-check>
                              <!-- end row -->
                      ...
                      <div class="tab-pane" id="Self-reliance">
                        <section>
                          <div>
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check :checked="$caseHistory->bath" name='bath' label="গোসল"
                              type="checkbox" :records="$caseConstants::$bath" secondaryInputLabel="বিস্তারিত লিখুন"
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->necessary_things" name='necessary_things'
                              ...
                              secondaryInputLabel="বিস্তারিত লিখুন" :isVertical="false" :multiple="true">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <!-- end row -->
                            <x-input-radio-or-check :checked="$caseHistory->play" name='play' label="খেলা"
                              type="checkbox" :records="$caseConstants::$game" :isVertical="false" :multiple="true">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->does_accept_routing_change"
                              name='does_accept_routing_change' label="রুটিনে কোন পরিবর্তন মেনে নেয় কি?রুটিন পছন্দ করে"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->does_move_all_time"
                              name='does_move_all_time' label="সবসময়ই নড়াচড়া বা চলাফেরার মধ্যে থাকে"
                              :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
                            ...
                            <x-input-radio-or-check :checked="$caseHistory->try_to_ignore_task"
                              name='try_to_ignore_task' label="কাজ এড়িয়ে চলতে চায়" :records="$constants::$yesNo">
                            </x-input-radio-or-check>
                            <!-- end row -->
