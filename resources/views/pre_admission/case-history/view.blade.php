                                        ...
                                        <div class="tab-content apply-view-only">
                                            ...
                                            <div class="tab-pane" id="referralInformation">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_adjustment_capability"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_education_intersted"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_self_work_capabelity"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->is_ableto_paly_others"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_any_learning_obstacle"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_control_over_body"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_speaking_problem"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->is_able_to_understand_tense"
                                            ...
                                            <div class="tab-pane" id="TheTrendOfEvolution">
                                                <section>
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->has_sleep_patten_problem"
                                            ...
                                            <div class="tab-pane" id="HistoryOfDevelopment">
                                                <section>
                                                    <div>
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->learned_to_chewing_in"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->learned_to_scrolling_in"
                                                        ...
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->Learned_thestructure"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->is_able_to_swimming"
                                                            name='is_able_to_swimming' label="শিশু কি সাঁতার জানে ?"
                                                            :records="$constants::$yesNo">
                                                        </x-input-radio-or-check>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->dose_like_play_outside"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->dose_get_tired_soon"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->dose_have_muscle_pain"
                                            ...
                                            <div class="tab-pane" id="LanguageSkills">
                                                <section>
                                                    <div>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->first_voice_lang"
                                            ...
                                            <div class="tab-pane" id="WorkingSkills">
                                                <section>
                                                    <div>
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->can_wear_cloth_alone"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->can_arrange_own_things"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->can_play_independently"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->can_obey_elder_commends"
                                            ...
                                            <div class="tab-pane" id="SocialSkills">
                                                <section>
                                                    <div>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_play_with_siblings"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_wait_for_his_turn"
                                                ...
                                                <section>
                                                    <div>
                                                        ...
                                                        <div class="row border-top py-2">
                                                            ...
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$caseHistory->can_write_himself"
                                                                name='can_write_himself' label="নিজে নিজে লিখতে পারে?"
                                                                :records="$constants::$yesNo">
                                                            </x-input-radio-or-check>
                                                            <!-- end row -->
                                                            <x-input-radio-or-check
                                                                :checked="$caseHistory->working_speed"
                                            ...
                                            <div class="tab-pane" id="Self-reliance">
                                                <section>
                                                    <div>
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check :checked="$caseHistory->bath"
                                                            name='bath' label="গোসল" type="checkbox"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->necessary_things"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check :checked="$caseHistory->play"
                                                            name='play' label="খেলা" type="checkbox"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_like_routine"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_like_new_situation"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->can_not_obey_regularity"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_get_angry_quickly"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_stop_working"
                                                            name='does_stop_working' label="কাজ করা বন্ধ করে দেয়"
                                                            :records="$constants::$yesNo">
                                                        </x-input-radio-or-check>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->is_there_instability"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_have_time_sense"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_move_in_one_place"
                                                            name='does_move_in_one_place' label="এক জায়গায় ঘোরে"
                                                            :records="$constants::$yesNo">
                                                        </x-input-radio-or-check>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check :checked="$caseHistory->does_move"
                                                            name='does_move' label="ঘোরাঘুরি করে"
                                                            :records="$constants::$yesNo">
                                                        </x-input-radio-or-check>
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_move_all_time"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_like_to_destroy"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->does_run_in_wrong_way"
                                                        ...
                                                        <x-input-radio-or-check name='staying_in_motion_all_the_time'
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->try_to_ignore_task"
                                                        ...
                                                        <!-- end row -->
                                                        <x-input-radio-or-check
                                                            :checked="$caseHistory->lost_again_and_again"
                                            ...
                                            <div class="tab-pane" id="Matters">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check name='i_listen_to_the_baby_later'
                                                        :checked="$caseHistory->i_listen_to_the_baby_later"
                                            ...
                                            <div class="tab-pane" id="report">
                                                <section>
                                                    ...
                                                    <div class="col-xl-12 col-sm-12">
                                                        <div class="mb-2">
                                                            <h5 class="">অন্যান্য প্রাসঙ্গিক চিকিৎসার তথ্য থাকলে রিপোর্ট
                                                                সংযুক্ত করুন-</h5>
                                                            <div class="input-group" id="datepicker2">
                                                                <x-input-text type="file"
