                                                    ...
                                                    <div class="tab-content apply-view-only">
                                                        ...
                                                        <div class="tab-pane" id="Common">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$common->from_where_you_learned_about_us ??
                                                                    ''"
                                                                ...
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$common->govt_disability_registration ?? ''"
                                                                ...
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$common->suggestion_on_obtaining_registration ??
                                                                    ''"
                                                                    name="suggestion_on_obtaining_registration"
                                                                    label="Suggestion on obtaining registration"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$common->referred_to_parents_forum ?? ''"
                                                        ...
                                                        <div class="tab-pane" id="TypesOfSpecialty">
                                                            <section>
                                                                ...
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->iss_she_has_utism ??
                                                                    ''"
                                                                    name="iss_she_has_utism" label="Is S/he has Autism?"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_down_syndrome ??
                                                                    ''"
                                                                    name="is_she_has_down_syndrome"
                                                                    label="Is S/he has Down Syndrome" :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$rectypes_of_specialty_disability_impairmentsord->is_she_has_cerebral_palsy ??
                                                                    ''"
                                                                    name="is_she_has_cerebral_palsy"
                                                                    label="Is S/he has Cerebral Palsy"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_intellectual_disability ??
                                                                    ''"
                                                                ...
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_dyslexia ??
                                                                    ''"
                                                                    name="is_she_has_dyslexia "
                                                                    label="Is S/he has Dyslexia " :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_learning_disability ??
                                                                    ''"
                                                                    name="is_she_has_learning_disability"
                                                                    label="Is S/he has Learning disability"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_anxiety_disorder ??
                                                                    ''"
                                                                    name="is_she_has_anxiety_disorder"
                                                                    label="Is S/he has Anxiety disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_adhd ??
                                                                    ''"
                                                                    name="=is_she_has_adhd " label="Is S/he has ADHD "
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_bipolar_disorder ??
                                                                    ''"
                                                                    name="is_she_has_bipolar_disorder "
                                                                    label="Is S/he has Bipolar Disorder "
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$rectypes_of_specialty_disability_impairmentsrd->is_he_has_speech_disorder ??
                                                                    ''"
                                                                    name="is_he_has_speech_disorder "
                                                                    label="Is S/he has Speech disorder "
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_language_disorder ??
                                                                    ''"
                                                                    name="is_she_has_language_disorder"
                                                                    label="Is S/he has Language disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_ocd ??
                                                                    ''"
                                                                    name="is_she_has_ocd" label="Is S/he has OCD"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_eating_disorder ??
                                                                    ''"
                                                                    name="is_she_has_eating_disorder"
                                                                    label="Is S/he has Eating disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$recotypes_of_specialty_disability_impairmentsrd->is_she_has_chizophrenia ??
                                                                    ''"
                                                                    name="is_she_has_chizophrenia"
                                                                    label="Is S/he has Schizophrenia" :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_multiple_personality_disorder ??
                                                                    ''"
                                                                    name="is_she_has_multiple_personality_disorder"
                                                                    label="Is S/he has Multiple Personality Disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_tic_disorder ??
                                                                    ''"
                                                                    name="is_she_has_tic_disorder"
                                                                    label="Is S/he has TIC disorder" :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_sluttering ??
                                                                    ''"
                                                                    name="is_she_has_sluttering"
                                                                    label="Is S/he has Sluttering" :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_depression ??
                                                                    ''"
                                                                    name="is_she_has_depression"
                                                                    label="Is S/he has Depression" :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_writing_disorder ??
                                                                    ''"
                                                                    name="is_she_has_writing_disorder"
                                                                    label="Is S/he has Writing disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_reading_disorder ??
                                                                    ''"
                                                                ...
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_match_disorder ??
                                                                    ''"
                                                                    name="is_she_has_match_disorder"
                                                                    label="Is S/he has Match Disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_attachment_disorder ??
                                                                    ''"
                                                                    name="is_she_has_attachment_disorder"
                                                                    label="Is S/he has Attachment Disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_separation_anxiety_disorder ??
                                                                    ''"
                                                                    name="is_she_has_separation_anxiety_disorder"
                                                                    label="Is S/he has Separation Anxiety Disorder"
                                                                    :records="$projectConstants::$yesNoDontknow" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$types_of_specialty_disability_impairments->is_she_has_sleep_disorder ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="Assessment">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$assessment->is_social_communication_checklist_has_completed ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_sensory_checklist_has_completed ??
                                                                    ''"
                                                                    name="is_sensory_checklist_has_completed?"
                                                                    label="Is Sensory Checklist has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_occupational_assessment_has_completed ??
                                                                    ''"
                                                                    name="is_occupational_assessment_has_completed?"
                                                                    label="Is Occupational Assessment has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_speech_and_language_assessment_has_completed ??
                                                                    ''"
                                                                    name="is_speech_and_language_assessment_has_completed"
                                                                    label="Is Speech and Language Assessment has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_physiotherapy_assessment_has_ompleted ??
                                                                    ''"
                                                                    name="is_physiotherapy_assessment_has_ompleted"
                                                                    label="Is Physiotherapy assessment has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_fundamental_movement_skills_has_completed ??
                                                                    ''"
                                                                    name="is_fundamental_movement_skills_has_completed"
                                                                    label="Is Fundamental Movement Skills has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_functional_evaluation_has_completed ??
                                                                    ''"
                                                                    name="is_functional_evaluation_has_completed"
                                                                    label="Is Functional evaluation has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_psychological_assessment_has_completed ??
                                                                    ''"
                                                                    name="is_psychological_assessment_has_completed"
                                                                    label="Is Psychological assessment has completed?"
                                                                    :records="$projectConstants::$yesNoWantdo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$assessment->is_cademic_assessment_has_completed ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="EducationalInformation">
                                                            <section>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->schooling ?? ''" name="schooling"
                                                                    type="checkbox" label="Schooling" :records="$projectConstants::$learnAbout"
                                                                    :isVertical="false" multiple="true"
                                                                    secondaryInputLabel="Please provide other school name" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_speaking_capacity ??
                                                                    ''"
                                                                    name="is_she_has_speaking_capacity"
                                                                    label="Is S/he has Speaking Capacity?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_listening_capacity ??
                                                                    ''"
                                                                    name="is_she_has_listening_capacity"
                                                                    label="Is S/he has Listening Capacity?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_reading_capacity ??
                                                                    ''"
                                                                    name="is_she_has_reading_capacity"
                                                                    label="Is S/he has Reading Capacity?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_writing_capacity ??
                                                                    ''"
                                                                    name="is_she_has_writing_capacity"
                                                                    label="Is S/he has Writing capacity?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has ?? ''"
                                                                    name="is_she_has" label="Is S/he has"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_counting_capacity ??
                                                                    ''"
                                                                    name="is_she_has_counting_capacity"
                                                                    label="Is S/he has Counting capacity? "
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$educational_information->is_she_has_money_concept ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="ChildConditionAtHisFamily">
                                                            <section>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_happy_at_home ??
                                                                    ''"
                                                                    name="is_she_happy_at_home"
                                                                    label="Is S/he Happy at home? " :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_lonely ??
                                                                    ''"
                                                                    name="is_she_lonely" label="Is S/he Lonely?"
                                                                    :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_protective ??
                                                                    ''"
                                                                    name="is_she_protective" label="Is S/he Protective?"
                                                                    :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_well_protective ??
                                                                    ''"
                                                                    name="is_she_well_protective"
                                                                    label="Is S/he Well protective?" :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_withdrawal ??
                                                                    ''"
                                                                    name="is_she_withdrawal" label="Is S/he Withdrawal?"
                                                                    :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_confident ??
                                                                    ''"
                                                                    name="is_she_confident" label="Is S/he Confident?"
                                                                    :records="$projectConstants::$yesMidNo" />
                                                                <!-- end row -->

                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_Communicate ??
                                                                    ''"
                                                                    name="is_she_Communicate" label="Is S/he Communicate?"
                                                                    :records="$projectConstants::$communicate" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->knowledge_on_aily_life_requirement ??
                                                                    ''"
                                                                    ...
                                                                    multiple="true" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_follow_instructions ??
                                                                    ''"
                                                                    name="is_she_follow_instructions"
                                                                    label="Is S/he Follow instructions?"
                                                                    :records="$projectConstants::$followInstruction" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_has_sitting_habit_and_how_long ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_has_hyperness ??
                                                                    ''"
                                                                ...
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_do_tantrum ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_do_self_injury ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->follow_any_specific_life_style ??
                                                                    ''"
                                                                    name="follow_any_specific_life_style"
                                                                    label="Follow any specific life style?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->what_is_the_way_of_communication ??
                                                                    ''"
                                                                    ...
                                                                    multiple="true" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->how_he_she_can_follow_instructions ??
                                                                    ''"
                                                                    name="how_he_she_can_follow_instructions"
                                                                    label="How he/she can Follow instructions?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$childs_condition_at_his_family->is_she_do_temper_how_long_it_remain ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="NumberOfChildrenInTheFamily">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$number_of_children_in_the_family->from_where_you_learned_about_us ??
                                                                    ''"
                                                                    name="from_where_you_learned_about_us"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$number_of_children_in_the_family->marriage_within_family_relative ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$number_of_children_in_the_family->is_any_other_relative_have_disabilities ??
                                                                    ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$number_of_children_in_the_family->family_economical_condition ??
                                                                    ''"
                                                        ...
                                                        <div class="tab-pane" id="Schooling">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check :checked="$schooling->going_to_school ?? ''"
                                                                    name="going_to_school" label="Going to school?"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$schooling->studied_till_which_class ?? ''"
                                                                    name="studied_till_which_class"
                                                                    label="Studied till which class?" :records="$projectConstants::$class"
                                                                    secondaryInputLabel="If yes, please share relation" />
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$schooling->why_not_attending_school ?? ''"
                                                                    name="why_not_attending_school" type="checkbox"
                                                                    label="Why not attending school?" :records="$projectConstants::$attendSchool"
                                                                    :isVertical="false" multiple="true"
                                                                    secondaryInputLabel="Please provide other information" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$schooling->any_exam_degree_achieved ?? ''"
                                                        ...
                                                        <div class="tab-pane" id="Home">
                                                            <section>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check :checked="$home->separate_room ?? ''"
                                                                    name="separate_room" label="Separate room"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->separate_bed ?? ''"
                                                                    name="separate_bed" label="Separate bed"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->sleep_alone ?? ''"
                                                                    name="sleep_alone" label="Sleep alone?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->separate_cupboard ?? ''"
                                                                    name="separate_cupboard" label="Separate Cupboard?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->separate_toilet ?? ''"
                                                                    name="separate_toilet" label="Separate toilet ?"
                                                                    :records="$projectConstants::$yesNoEn" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->own_equipment ?? ''"
                                                                    name="own_equipment" label="Own equipment"
                                                                    :records="$projectConstants::$Ph" secondaryInputLabel="Other" />
                                                                <!-- row end -->
                                                                <x-input-radio-or-check :checked="$home->anything_else ?? ''"
                                                                    name="anything_else" label="Anything else"
                                                                    :records="$projectConstants::$yesNoEn"
