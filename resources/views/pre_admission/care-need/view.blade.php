                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="Personal_Care_Needs">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check name="eat_drink_swallow" type="checkbox"
                                                        :multiple="true" label="Eat /drink/ swallow"
                                                    ...
                                                    <x-input-radio-or-check name="brushing_teeth" type="checkbox"
                                                        :multiple="true" label="Brushing teeth/mouth care"
                                            ...
                                            <div class="tab-pane" id="Physical_Health_Needs">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check label="Mobility/Walking Aids required?"
                                                        :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    {{-- end row --}}

                                                    <x-input-radio-or-check label="Handling objects/Grip Aids required?"
                                                        :records="$constants::$yesNoEn">
                                                    </x-input-radio-or-check>
                                                    {{-- end row --}}
                                            ...
                                            <div class="tab-pane" id="Social_Needs">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check name="Recognizing_Managing_basic_Emotions"
                                                    ...
                                                    <div class="row border-top py-2 mt-3">
                                                        <div class="col-xl-12 col-sm-12">
                                                            <div class="m-0">
                                                                ...
                                                                <div class="mb-2">
                                                                    <x-input-text name="name_of_parent" placeholder="">
                                                                    </x-input-text>
                                                                </div>
                                                            </div>
                                                        </div>
