                                                        ...
                                                        <section>
                                                            <form>
                                                                ...
                                                                <x-input-radio-or-check name="eat_drink_swallow"
                                                                    type="checkbox" label="Eat /drink/ swallow"
                                                                ...
                                                                <div class="mt-3">
                                                                    ...
                                                                    <textarea id="formmessage" class="form-control"
                                                                        rows="1" placeholder="Enter Answer"></textarea>
                                                                </div>
                                                                <!-- end row -->
                                                                ...
                                                                <x-input-radio-or-check name="brushing_teeth"
                                                                    type="checkbox" label="Brushing teeth/mouth care"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check type="checkbox" label="Dressing"
                                                                    :records="$careConstants::$dressing"
                                                                    :isVertical="false">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                ...
                                                                <div class="row border-top py-2 mt-3">
                                                                    <div class="col-xl-12 col-sm-12">
                                                                        <div class="m-0">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <x-input-text name="other_personal_care_of_daily_living"
                                                                                    placeholder="">
                                                                                </x-input-text>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row border-top py-2 mt-3">
                                                                    <div class="col-xl-12 col-sm-12">
                                                                        <div class="m-0">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <x-input-text name="detailes_of_past_or_long_term_medical_conditions" placeholder="">
                                                                                </x-input-text>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row border-top py-2 mt-3">
                                                                    <div class="col-xl-12 col-sm-12">
                                                                        <div class="m-0">
                                                                            ...
                                                                            <div class="mb-2">
                                                                                <x-input-text name="more_information" placeholder="">
                                                                                </x-input-text>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row border-top py-2">
                                                                    <div class="col-xl-12 col-sm-12">
                                                                        <div class="m-0">
                                                                            ...
                                                                            <div class="mt-3">
                                                                                <div>
                                                                                    <x-input-text name="confirmed_all_information" placeholder="">
                                                                                    </x-input-text>
                                                                                </div>
                                                                            </div>
                                                                        </div>
