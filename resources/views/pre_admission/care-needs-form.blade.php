                                    ...
                                    <div class="wizard-container">
                                        <div class="card_stap wizard-card row" data-color="red" id="wizard">
                                                ...
                                                <div id="wizard-navigation">
                                                    <ul class="wizard-navigation">
                                                        <li class="w-100"><a href="#case_history_init"
                                                                             data-toggle="tab">CARE Needs - Part 2</a>
                                                        </li>
                                                        <li class="w-100"><a href="#referral_information"
                                                                             data-toggle="tab">2nd part: Assessment</a>
                                                        </li>
                                            ...
                                            <div class="col-sm-9 col-md-9">
                                                <form action="{{route('care-need.index')}}" method="POST">
                                                    @csrf
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                ...
                                                                                ID:</label>
                                                                            <x-input-select :records="[]"
                                                                                            name="student_id"></x-input-select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
