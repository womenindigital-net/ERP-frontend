                        ...
                        <div class="tab-pane active" id="case-histroy" role="tabpanel">
                            <div class="modal-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex  mb-3">
                                        <label for="example-text-input"
                                            class="col-md-4 col-form-label  pe-2">Designation:</label>
                                        <div class="col-md-8">
                                            <x-input-text name="designation" />
                                        </div>
                                    </div>
                                    <div class="col-6 d-flex mb-3">
                                        <label for="example-text-input" class="col-md-4 col-form-label  pe-2">Joining
                                            Date:</label>
                                        <div class="col-md-8">
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="row p-3">
                                    <div class="col-6 d-flex  mb-3">
                                        <label for="example-text-input"
                                            class="col-md-4 col-form-label  pe-2">Title:</label>
                                        <div class="col-md-8">
                                            <x-input-text name="title" />
                                        </div>
                                    </div>
                                    <div class="col-6 d-flex mb-3">
                                        <label for="example-text-input" class="col-md-4 col-form-label  pe-2">Notice
                                            Type:</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="col-6 d-flex  mb-3">
                                        <label for="example-text-input"
                                            class="col-md-4 col-form-label  pe-2">Message:</label>
                                        <div class="col-md-8">
