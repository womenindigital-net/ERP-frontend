                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                          <div class="mb-3">
                                             ...
                                             <x-input-text name="adviceletter_sub" type="text"
                                             placeholder="">
                                            </x-input-text> 
                                         </div>
                                       </div>  
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <x-input-textarea name="adviceletter_des" type="text"
                                                    placeholder="">
                                                    </x-input-textarea>
                                                </div>
                                            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-success btn-rounded waves-effect waves-light mb-2 me-1" data-bs-toggle="modal" data-bs-target=".material-callects-modal-xl-add">
