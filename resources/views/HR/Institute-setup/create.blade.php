                            ...
                            <div class="container">
                                ...
                                <div class="row d-flex">
                                    <div class="col-12 d-flex  mb-3">
                                        <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Institute Name:</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="col-12 d-flex  mb-3">
                                        <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Note:</label>
                                        <div class="col-md-8">
                                            <x-input-textarea name="note" type="text"
                                            placeholder="">
                                            </x-input-textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-primary">  Result Details
                                </h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-success mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">Inst Address</th>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Inst Note</th>
                                                <td></td>
                                            </tr>
                                            <tr>
