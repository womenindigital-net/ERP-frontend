                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <x-input-text name="yousuf" type="text" placeholder="Enter Requisition Number here">
                                    </x-input-text>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <x-input-text name="yousuf" type="text" placeholder="Enter Requisition Name here">
                                    </x-input-text>
                                </div>
                            </div>
                            <div class="col-md-6">
