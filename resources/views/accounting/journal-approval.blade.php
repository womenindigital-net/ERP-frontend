                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 text-end">
                            <button type="button" class="btn btn-outline-info waves-effect waves-light mb-5" data-bs-toggle="modal" data-bs-target=".journal-modal-xl-add"> <i class="fas fa-plus-circle"></i> Add</button>
                        </div>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1" data-bs-toggle="modal" data-bs-target=".journal-view"><i class="fas fa-eye"></i></button>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1" data-bs-toggle="modal" data-bs-target=".journal-view"><i class="fas fa-eye"></i></button></td>

                            </tr>
                        </tbody>
                    </table>
                    <!-- sample modal content -->
                    <div class="modal fade journal-view" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <p class="form-control">Payment for Student. Student ID: 220, Name: Ishmam Reza</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
