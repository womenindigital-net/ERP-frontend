                ...
                <div class="card-body p-0">
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="sale_voucher" role="tabpanel">
                            <form method="post" action="{{route('sale-voucher.store')}}">
                            @csrf
                            <!-- form start -->
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label>Date</label>
                                            <x-input-text type="date" name="date" placeholder="">
                                            </x-input-text>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                                        ...
                                                        <div data-repeater-item class="row removeRow">
                                                            ...
                                                            <div class=" col-lg-2 p-0 pe-1 pb-1">
                                                                <x-input-select class="select-product" name="product_id"
                                                                                :records="$products" additional="code"/>
                                                            </div>
                                                            ...
                                                            <div class=" col-lg-2 p-0 pe-1 pb-1">
                                                                <x-input-text name="qty" placeholder="" class="qty">
                                                                </x-input-text>
                                                            </div>
    ...
    <script>
        $ ( document ).ready ( function () {
            /*$("#category_id").change(function(e) {
                ...
                if (categoryId) {
                    let url = '{{route('getProductsAccordingCategory', ":categoryId")}}';
