                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <div id="wizard-navigation">
                                            <ul class="wizard-navigation">
                                                ...
                                                <li class="w-100"><a href="#afterdinner" data-toggle="tab">শিক্ষার্থীদের
                                                        দৈনন্দিন রুটিনের সাজেশন >
                                                        রাতে শোবার আগে</a></li>
                                                ...
                                                <section>
                                                    <div class="mb-3">
                                                        <label for="basicpill-firstname-input">Special Educator
                                                            Team</label>
                                                        <div class="input-group" id="datepicker2">
                                                            <x-input-text value="" name="special_educator_team"
                                                                type="file">
                                                            </x-input-text>
                                                        </div>
                                                        <!-- input-group -->
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="basicpill-firstname-input">Special Educator
                                                            Team Name</label>
                                                        <div class="input-group" id="datepicker2">
                                                            <x-input-text value="" name="special_educator_team_name">
                                                            </x-input-text>
                                                        </div>
                                                        <!-- input-group -->
                                                    </div>
                                                ...
                                                <section>
                                                    <div class="mb-3">
                                                        <label for="basicpill-firstname-input">স্বাক্ষর-
                                                            টিচার</label>
                                                        <x-input-text value="" name="signature_teacher" type="file">
                                                        </x-input-text>
                                                        <!-- input-group -->
                                                    </div>
                                                    <div class="mb-3">
