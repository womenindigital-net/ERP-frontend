                                            ...
                                            <div class="tab-pane" id="ActivitiesofDailyLiving">
                                                <section>
                                                    <x-input-radio-or-check name="bath" label="গোসল"
                                                                            :records="$tripReportConstants::$do" :checked="$activitiesOfDailyLiving->bath"
                                                                            secondaryInputLabel="সাজেশন" secondaryInputValue="{{$activitiesOfDailyLiving->bath_secondary}}">
