                                ...
                                <div class="wizard-container">
                                    <div class="card wizard-card" data-color="red" id="wizard">
                                        <form action="" method="">
                                            ...
                                            <div class="wizard-navigation" id="wizard-navigation" style="display: none">
                                                <ul>
                                                    <li><a href="#incident_record_first" data-toggle="tab">Incident
                                                            Record</a></li>
                                                    <li><a href="#incident_record_second" data-toggle="tab">Incident
                                                            Record</a></li>
                                                </ul>
                                            </div>
                                                    ...
                                                    <section>
                                                            ...
                                                            <div class="form-check">
                                                                <div class="me-5 ">
                                                                    <label class="form-check-label pb-2">Date and
                                                                        Time</label>
                                                                    <x-input-text name="date" placeholder="dd/mm/yyyy"
                                                                        type="date">
                                                                    </x-input-text>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row border-top py-2">
                                                            <div class="form-check">
                                                                ...
                                                                <div class="me-5 ">
                                                                    <label class="form-check-label pb-2">Duration ( in
                                                                        Minutes)</label>
...
// Just For Horizontal Menu
$("#horizontal_nev").append($("#wizard-navigation").html());
