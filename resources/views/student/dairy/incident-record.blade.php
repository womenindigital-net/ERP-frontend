                                ...
                                <div class="row border-top py-2">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="row">
                                                <div class="form-check">
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label"> Beginning a new
                                                            activity</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                    ...
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">Transitions between
                                                            classrooms</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                    ...
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">Asked for a particular
                                                            task</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">Observed same activity of
                                                            teacher by students</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">Asked to do preferred
                                                            activity</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">Asked to do non preferred
                                                            activity</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                    ...
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                                        <label class="form-check-label">For fulfillment of same
                                                            purpose</label>
                                                    </div>
                                                    <div class="me-5 ">
                                                        <input class="form-check-input" type="radio" name="formRadios">
                                    ...
                                    <div class="row border-top py-2">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                                name="formRadios">
                                                            <label class="form-check-label">Leaving area without
                                                                permission</label>
                                                        </div>
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                                name="formRadios">
                                                            <label class="form-check-label">Did not follow teacher’s
                                                                instruction</label>
                                                        </div>
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                        ...
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                                name="formRadios">
                                                            <label class="form-check-label">Calling teachers name
                                                                disrespectfully</label>
                                                        </div>
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                                name="formRadios">
                                                        ...
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                                                name="formRadios">
                                                            <label class="form-check-label">Climbing on
                                                                furniture</label>
                                                        </div>
                                                        <div class="me-5 ">
                                                            <input class="form-check-input" type="radio"
                                        ...
                                        <div class="row border-top py-2">
                                            <div class="form-check">
                                                <div class="me-5 ">
                                                    <label class="form-check-label pb-2">Others ( please
                                                        specify)</label>
                                                    <input type="text" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row border-top py-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-check">
                                                            ...
                                                            <div class="me-5 ">
                                                                <input class="form-check-input" type="radio"
                                                                    name="formRadios">
                                                                <label class="form-check-label">Hurt ( mild/ moderate/
                                                                    Severe) </label>
                                                            </div>
                                                            <div class="me-5 ">
                                                                <input class="form-check-input" type="radio"
                                                                    name="formRadios">
                                                                <label class="form-check-label">Mentally
                                                                    disturbed</label>
                                                            </div>
                                                            <div class="me-5 ">
                                                                <input class="form-check-input" type="radio"
                                                                    name="formRadios">
                                                                <label class="form-check-label">Others ( please
                                                                    specify)</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row border-top py-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-check">
                                                                <div class="me-5 ">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="formRadios">
                                                                    <label class="form-check-label">Student
                                                                        himself</label>
                                                                </div>
                                                                <div class="me-5 ">
                                                                    <input class="form-check-input" type="radio"
                                                                ...
                                                                <div class="me-5 ">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="formRadios">
                                                                    <label class="form-check-label">Object / Property
                                                                        Damages</label>
                                                                </div>
                                                                <div class="me-5 ">
                                                                    <input class="form-check-input" type="radio"
                                                ...
                                                <div class="row border-top py-2">
                                                    <div class="form-check">
                                                        <div class="me-5 ">
                                                            <label class="form-check-label pb-2">Specify any extra
                                                                information, if any.</label>
                                                            <input type="text" class="form-control" placeholder="">
                                                        </div>
                                                        <div class="me-5 ">
                                                            <label class="form-check-label pb-2">How could harm
                                                                occur?</label>
                                                            <input type="text" class="form-control" placeholder="">
                                                        </div>
                                                        <div class="me-5 ">
                                                            <label class="form-check-label pb-2">If other, please
                                                                specify</label>
                                                            <input type="text" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row border-top py-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-check">
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Directed to
                                                                            calming area</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Changed
                                                                            assignment</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Changed working
                                                                            area</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Gave non verbal
                                                                            cue</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Gave verbal
                                                                            warning</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Behavior
                                                                            modification</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Focus on next
                                                                            learning activity</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Provided
                                                                            exercise as instructed by gym
                                                                            instructor</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Primary aid
                                                                            provided</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">intervention by
                                                                            therapist</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                    ...
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Administrative
                                                                            intervention</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Informed
                                                                            parents</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                                        <label class="form-check-label">Referred for
                                                                            medical support</label>
                                                                    </div>
                                                                    <div class="me-5 ">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="formRadios">
                                                    ...
                                                    <div class="row border-top py-2">
                                                        <div class="form-check">
                                                            <div class="me-5 ">
                                                                <label class="form-check-label pb-2">Who will complete
                                                                    the action?</label>
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row border-top py-2">
                                                        <div class="form-check">
                                                            <div class="me-5 ">
                                                                <label
                                                                    class="form-check-label pb-2">Recommendation</label>
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row border-top py-2">
                                                        <div class="form-check">
                                                            <div class="me-5 ">
                                                                <label class="form-check-label pb-2">Any other related
                                                                    issue that you want to keep, please write</label>
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row border-top py-2">
                                                        <div class="form-check">
                                                            <div class="me-5 ">
                                                                <label class="form-check-label pb-2">Action completion
                                                                    Date</label>
                                                                <input class="form-control" type="date"
                                                                    value="2019-08-19" id="example-date-input">
                                                            </div>
                                                            <div class="me-5 ">
                                                                <label class="form-check-label pb-2">When will the
                                                                    assessment be reviewed?</label>
                                                                <input class="form-control" type="date"
                                                                    value="2019-08-19" id="example-date-input">
                                                            </div>
                                                        </div>
