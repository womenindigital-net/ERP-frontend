      ...
      <div class="card-body">
        <div class="row mb-3">
          ...
          <div class="col-6 text-end  mb-3">
            ...
            <button type="button" class="btn btn-outline-info waves-effect waves-light ms-2" data-bs-toggle="modal"
            ...
            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                ...
                <tbody>
                    ...
                    <td>Create: Arif Dev @ 2018-07-28 07:38:02
                        Update: Arif Dev @ 2018-07-28 09:04:25
                        </td>
                    <td>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3 row ms-2">
                                    ...
                                    <div class="col-md-8">
                                        <select name="PrescriptionID" class="form-control strip-tags" id="PrescriptionID" required="">
                                            <option value="">--Select--</option>
