                                                        ...
                                                        <div class="tab-pane" id="Pragmatic_Objective">
                                                            <section>
                                                                    ...
                                                                    <x-input-radio-or-check name="dumble"
                                                                        label="Dumble (10x4)6,8,10 lb" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
                                                                    <x-input-radio-or-check name="Leg_curl"
                                                                        label="Leg curl (10x4)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
                                                                    <x-input-radio-or-check name="vibration"
                                                                        label="Vibration (10 min)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
                                                                    <x-input-radio-or-check name="spot_jump"
                                                                        label="Spot jump (10x2)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
                                                                    ...
                                                                    <x-input-radio-or-check name="ball_throw"
                                                                        label="Ball throw (15)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
                                                        ...
                                                        <div class="tab-pane" id="Outing">
                                                            <section>
                                                                    <x-input-radio-or-check name="walking"
                                                                        label="Walking (20 min)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}

                                                                    <x-input-radio-or-check name="running"
                                                                        label="Running (15 min)" :records="$gymoutingConstants::$assistance"
                                                                        secondaryInputLabel=""></x-input-radio-or-check>
                                                                    {{-- end row --}}
