                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <x-input-select :selected="$record->parent_category" name="parent_category" :records="$parent_category" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Name</label>
                                            <x-input-text name="title" value="{{ $record->title }}" placeholder="Category Name Here"></x-input-text>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
