                    ...
                    <form action="{{ route('warehouse.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <x-input-select name="managed_by" :records="$user"  />
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Store type</label>
                            <div class="col-sm-9">
                                <x-input-select name="store_type"
                                    :records="['Warehouse' =>'Warehouse', 'Office Location' =>'Office Location']" />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Description</label>
                        ...
                        <div class="row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Managed by</label>
                            <div class="col-sm-9">
                                <x-input-select name="managed_by" :records="$managed_by" targetColumn="title" />
                            </div>
                        </div>
                        <div class="d-flex  flex-wrap float-end gap-2">
