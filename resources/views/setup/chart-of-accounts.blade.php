                                                    ...
                                                    <div class="card p-0 m-0">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-md-9 ">
                                                                        <select class="form-control form-select">
                                                                            ...
                                                                            <option value="5">Allowance for Uncollectible
                                                                                Accounts</option>
                                                                            <option value="6">Contracts</option>
                                                                            <option value="7">Employee Trustee receivables
                                                                            </option>
                                                                            <option value="8">Demurrage by teachers which
                                                                                has not paid yet</option>
                                                                            ...
                                                                            <option value="13">First Security Islami Bank
                                                                                Ltd</option>
                                                                            <option value="17">Mutual Trust bank</option>
                                                                            <option value="18">Standard Chartered Bank
                                                                            </option>
                                                                            <option value="19">Instalment Receivables
                                                                            </option>
                                                                            <option value="20">Notes and loans receivable
                                                                            </option>
                                                                            <option value="21">Pledges receivable</option>
                                                                            <option value="22">Student Receivable</option>
                                                                            <option value="23">Demurrage by student which
                                                                                has not paid yet</option>
                                                                            <option value="24">Students who have not paid
                                                                                their fees</option>
                                                                            <option value="25">whose admission fees are paid
                                                                                in instalment</option>
                                                                            ...
                                                                            <option value="35">Accumulated Depreciation
                                                                            </option>
                                                                            <option value="36">Accumulated depreciation -
                                                                                Building</option>
                                                                            <option value="37">Accumulated depreciation -
                                                                                Furniture &amp; Fixture</option>
                                                                            <option value="38">Accumulated depreciation -
                                                                                Others</option>
                                                                            <option value="39">Accumulated depreciation -
                                                                                Vehicle</option>
                                                                            <option value="40">Accumulated depreciation
                                                                                -Computer Allied</option>
                                                                            <option value="41">Accumulated depreciation
                                                                                -Kitchen Equipment Croc</option>
                                                                            <option value="42">Accumulated depreciation
                                                                                -Office Equipments Mach</option>
                                                                            <option value="43">Accumulated depreciation
                                                                                -Training Educational E</option>
                                                                            <option value="44">Annual Events/Program
                                                                                Expenses</option>
                                                                            <option value="45">1st January New Year event
                                                                            </option>
                                                                            <option value="46">Bangabandhu Birthday 17 March
                                                                            </option>
                                                                            <option value="47">Different Cultural shows /
                                                                                Mela etc</option>
                                                                            <option value="48">Disability Day - National
                                                                                Program 3rd December</option>
                                                                            <option value="49">Eid Programmes</option>
                                                                            <option value="50">Independence Day 26 March
                                                                            </option>
                                                                            <option value="51">International Language Day 21
                                                                                February</option>
                                                                            <option value="52">National Mourn Day 17 August
                                                                            </option>
                                                                            <option value="53">National Victory Day -16
                                                                                December</option>
                                                                            <option value="54">Pohela Baishakh 14 April
                                                                            </option>
                                                                            <option value="55">VTC Anniversary Programme 15
                                                                                October</option>
                                                                            <option value="56">World Autism Awareness Day
                                                                                programme2nd April</option>
                                                                            ...
                                                                            <option value="69">COGS from Art and Craft
                                                                            </option>
                                                                            <option value="70">COGS from Block cloths
                                                                            </option>
                                                                            <option value="80">COGS of Block Blouse</option>
                                                                            <option value="90">COGS of Block Hijab, Dopatta
                                                                            </option>
                                                                            <option value="91">COGS of Block other items
                                                                            </option>
                                                                            <option value="92">COGS of Block Panjabi
                                                                            </option>
                                                                            <option value="93">COGS of Block Salwar, Kamiz,
                                                                                Dipattta</option>
                                                                            <option value="94">COGS of Block Sharee</option>
                                                                            <option value="95">COGS of Block T-Shirt
                                                                            </option>
                                                                            <option value="96">COGS from Carpet Slipper
                                                                            </option>
                                                                            <option value="97">COGS from Catering food
                                                                            </option>
                                                                            <option value="98">Catering Revenue (Inside
                                                                                Staff)</option>
                                                                            <option value="99">Catering Sales (Inside
                                                                                Students)</option>
                                                                            <option value="100">Catering Sales (Outsiders)
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3 row">
                                                                    <label for="example-search-input"
                                                                        class="col-md-3 col-form-label ">Opening
                                                                        Balance:</label>
                                                                    <div class="col-md-9 ">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-md-9 ">
                                                                        <input class="form-control" type="number"
                                                                            placeholder="Current Balance hete"
                                                                            id="example-search-input">
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-md-9 ">
                                                                        <input class="form-control" type="number"
                                                                            placeholder="Tier No" id="example-search-input">
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="example-search-input"
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-md-9 ">
                                                                        <div class="square-switch">
                                                                            <input type="checkbox" id="square-switch4"
                                                                                switch="bool" checked />
