...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Stock Transfer <?php $__env->endSlot(); ?>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary">Stock Transfer<i class=" fas fa-eye bx-tada"></i>
                    </h5>
                    ...
                    <!-- journal form start -->
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Issue Type</label>
                                    <p class="form-control">Issue Type</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Location From</label>
                                    <p class="form-control">Location From</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Location To</label>
                                    <p class="form-control">Location To</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\github\ERP-frontend-wid\resources\views/stock_transfer.blade.php ENDPATH**/ ?>