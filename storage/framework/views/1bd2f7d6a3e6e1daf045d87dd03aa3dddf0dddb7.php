                                            ...
                                            <div class="row">
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="form-control" type="search"
                                                                placeholder="Advanced Amount" id="example-search-input">
                                                        </div>
                                                        <div class="col-md-3">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  w-100">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> <i class="fas fa-pen pe-3"></i><i class="fas fa-trash-alt"></i>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Lee Wrangter</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\ERP-frontend-WID\resources\views/setup/customers-list/customer-reg.blade.php ENDPATH**/ ?>