...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('functional_communications', function(Blueprint $table)
        {
            ...
            $table->string('has_difficulty_understanding_facial_expressions_or_body_language')->nullable();
            $table->string('has_difficulty_understanding_facial_expressions_or_body_language_secondary')->nullable();
            $table->string('use_inappropriate_body_orientation_or_proximity_in_interaction')->nullable();
            $table->string('use_inappropriate_body_orientation_or_proximity_in_interaction_secondary')->nullable();
            ...
            $table->string('has_difficulty_understanding_or_using_humor_appropriately')->nullable();
            $table->string('has_difficulty_understanding_or_using_humor_appropriately_secondary')->nullable();
