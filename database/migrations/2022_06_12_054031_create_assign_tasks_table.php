...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('assign_tasks', function (Blueprint $table) {
            ...
            $table->string('physical_growth')->nullable();
            $table->string('good_touch')->nullable();
            $table->string('decision_making')->nullable();
            $table->string('generalization_ability')->nullable();
            $table->string('functional_reading_skills')->nullable();
            $table->string('includes_fine_motor_skills')->nullable();
            $table->string('time_skills')->nullable();
            $table->string('respond')->nullable();
            $table->string('verbs')->nullable();
            $table->string('listening_skills')->nullable();
            $table->string('request')->nullable();
            $table->string('speaking')->nullable();
            $table->string('pragmatic_communication')->nullable();
            $table->string('washing_showering')->nullable();
            $table->string('basic_first_aid_knowledgee')->nullable();
            $table->string('preparation_skills')->nullable();
            $table->string('cooking_preparation')->nullable();
            $table->string('intrapersonal')->nullable();
            $table->string('prompting')->nullable();
            ...
            $table->string('games_how_to_play_with_others')->nullable();
            $table->string('sharing_personal_issues')->nullable();
            $table->string('self_development')->nullable();
            ...
            $table->string('functional_reading_skillss')->nullable();
