...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('socials', function(Blueprint $table)
        {
            ...
            $table->json('functional_intent_a_responsiveness')->nullable();
            $table->json('functional_intent_b_instrumental_states_needs')->nullable();
            $table->json('functional_intent_c_requesting')->nullable();
            $table->json('dunctional_intent_d_prosody')->nullable();
            $table->json('functional_intent_e_Protests')->nullable();
            // $table->json('')->nullable();
            $table->json('functional_intent_g_humor')->nullable();
            $table->json('functional_intent_h_greetingsacknowledgements')->nullable();
            $table->json('functional_intent_i_problem_solving')->nullable();
            $table->json('functional_intent_j_deceit')->nullable();
